...
extern tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_17295614_;
extern NIM_BOOL nimInErrorMode__759bT87luu8XGcbkw13FUjA;
extern tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_17305632_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_17295696_;
extern tyProc__kxUw9cdxJbPtv0iPyoSbDBQ Dl_17295719_;
extern tyProc__HBcM2Mt9bfW9bP8CkO25r0mA Dl_17296026_;
extern tyProc__ILGNrKdZ6rU9bHuzDylmHhA Dl_17296020_;
extern tyProc__e47RoMUolEGMiUlfiZt9abQ Dl_17295619_;
extern NI osInvalidSocket__voz9aUXu8jtRbvGZZJHNE8w;
extern tyProc__IV3cwg4tBg3JP8ITSKt7oQ Dl_14078456_;
extern tyProc__T129bsPZ4FvuSF4rGFSBKkg Dl_14078281_;
extern tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_17295616_;
extern tyProc__EJ9cbYwLVOng2t4wnewGkmA Dl_17295692_;
extern Exception* currException__9bVPeDJlYTi9bQApZpfH8wjg;
extern Exception* currException__9bVPeDJlYTi9bQApZpfH8wjg;
extern Exception* currException__9bVPeDJlYTi9bQApZpfH8wjg;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_17295706_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_17295723_;
extern tyProc__sG7rgqmtlgBaumPwwN3BfQ Dl_17295714_;
extern tyProc__4YBDaTH9b4xNNXSV9ahdJZ8w Dl_14078345_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_17295726_;
extern tyProc__09aW01hZ1tSPafLaWVpBcXA Dl_17295709_;
extern tyProc__4YBDaTH9b4xNNXSV9ahdJZ8w Dl_14078320_;
extern tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_17295632_;
extern tyProc__HXibadfWHwHwyhCwpIRD2A Dl_17280665_;
extern tyProc__2PA7CxitARKs0jpUW1gQ0g Dl_17295655_;
extern tyProc__J5jVzoevP749cPcyUg9cwPEA Dl_17305414_;
extern tyProc__H5wL7jexPlRA7WCw9cqLm0A Dl_17295643_;
extern tyProc__tYatIIo0oRSB9bjHLep7yhQ Dl_17295664_;
extern tyProc__xjxKRHVZXDqdWXw9bunoZ3w Dl_17295668_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_17295673_;
...
{ {
 ...
 err=Dl_17296026_();
 {
  ...
  (*T10_).Sup.Sup.message=copyString(((NimStringDesc*)&TM__XqsrSBxhOTPgLQ9cX4MmV4A_7));
...
appendString(T13_,((NimStringDesc*)&TM__XqsrSBxhOTPgLQ9cX4MmV4A_8));
...
{nimErr_=nimErrorFlag();
 {
  if(!(*socket_0).isSsl)goto LA3_;
  {
   ...
   ret=Dl_17295719_((*socket_0).sslHandle,((int)(err)));
   switch(ret){
   case((NI)6):
   {
...
appendString(errStr,((NimStringDesc*)&TM__XqsrSBxhOTPgLQ9cX4MmV4A_14));
     ...
     LA38_: ;
     {
      ...
      NimStringDesc* T42_;
      T41_=(NCSTRING)0;
      T41_=Dl_17296020_(sslErr,NIM_NIL);
...
appendString(T42_,((NimStringDesc*)&TM__XqsrSBxhOTPgLQ9cX4MmV4A_15));
appendString(T42_,errStr_2);
...
{nimErr_=nimErrorFlag();
 {
  ...
  if(!T4_)goto LA6_;
  {
   ...
   if(!T10_)goto LA13_;
   Dl_17305632_();
   res=Dl_17295696_((*socket_0).sslHandle);
   {
   ...
   LA17_: ;
   {
    ...
    if(NIM_UNLIKELY(*nimErr_))goto LA1_;
    sslError=Dl_17295719_((*socket_0).sslHandle,res);
    {
     NIM_BOOL T24_;
     T24_=(NIM_BOOL)0;
 ...
 }
 {
  oldNimErrFin1_=*nimErr_;*nimErr_=NIM_FALSE;
  {
   ...
   LA39_: ;
   if(!T38_)goto LA40_;
   Dl_17295619_((*socket_0).sslHandle);
  ...
  while(1){
   if(!!((it==NIM_NIL)))goto LA5;
   {
    ...
    LA15_: ;
    {
     int T40_;
     T40_=(int)0;
     T40_=Dl_14078281_(lastFd,(*it).ai_addr,((unsigned int)((*it).ai_addrlen)));
...
appendString(T69_,((NimStringDesc*)&TM__XqsrSBxhOTPgLQ9cX4MmV4A_19));
...
{nimErr_=nimErrorFlag();
 ...
 (*socket_0).sslHandle=Dl_17295616_((*(*socket_0).sslContext).context);
 ...
 LA3_: ;
 {
  int T7_;
  T7_=(int)0;
  T7_=Dl_17295692_((*socket_0).sslHandle,(*socket_0).fd);
...
{ nimZeroMem((void*)(&result),sizeof(tyObject_IpAddress__t0yd6ha54oWXm7nwZ4QqfA));
 ...
 LA89_: ;
 {
    ...
    while(1){
     ...
     c_2=colontmp_->data[i_4];
     {
      ...
      currentShort=(NU32)((NU32)((NU32)((NU32)(currentShort)*(NU32)(((NU32)10))))+(NU32)(((NU32)((NI)(((NU8)(c_2))-((NI)48))))));
      {
       ...
       (*T114_).Sup.Sup.message=copyString(((NimStringDesc*)&TM__XqsrSBxhOTPgLQ9cX4MmV4A_27));
     ...
     LA108_: ;
     {
      if(!((NU8)(c_2)==(NU8)(46)))goto LA116_;
      {
       ...
       (*T124_).Sup.Sup.message=copyString(((NimStringDesc*)&TM__XqsrSBxhOTPgLQ9cX4MmV4A_21));
     ...
     LA116_: ;
     {
      ...
      (*T126_).Sup.Sup.message=copyString(((NimStringDesc*)&TM__XqsrSBxhOTPgLQ9cX4MmV4A_28));
  ...
  }
  {
   ...
   (*T133_).Sup.Sup.message=copyString(((NimStringDesc*)&TM__XqsrSBxhOTPgLQ9cX4MmV4A_21));
 ...
 LA87_: ;
 {
  ...
  (*T138_).Sup.Sup.message=copyString(((NimStringDesc*)&TM__XqsrSBxhOTPgLQ9cX4MmV4A_24));
 ...
 LA136_: ;
 {
  ...
  if(!(groupCount<((NI)8)))goto LA140_;
  {
   ...
   (*T146_).Sup.Sup.message=copyString(((NimStringDesc*)&TM__XqsrSBxhOTPgLQ9cX4MmV4A_29));
 ...
 LA140_: ;
 {
  ...
  (*T156_).Sup.Sup.message=copyString(((NimStringDesc*)&TM__XqsrSBxhOTPgLQ9cX4MmV4A_24));
...
{nimErr_=nimErrorFlag();
 ...
 case((tyEnum_SslHandshakeType__9aZhh5f9bRDKgYB8GLASDSqg)0):
 {
  ...
  LA7_: ;
  Dl_17305632_();
  ret=Dl_17295706_((*socket_0).sslHandle);
 ...
 case((tyEnum_SslHandshakeType__9aZhh5f9bRDKgYB8GLASDSqg)1):
 {
  int ret_2;
  Dl_17305632_();
  ret_2=Dl_17295723_((*socket_0).sslHandle);
...
{ result=(NI)0;
 {
  ...
  Dl_17305632_();
  T5_=(int)0;
  T5_=Dl_17295714_((*socket_0).sslHandle,((NCSTRING)(data)),size);
  result=((NI)(T5_));
  goto BeforeRet_;
 }
 LA3_: ;
 T6_=(int)0;
 T6_=Dl_14078345_((*socket_0).fd,data,((int)(size)),((NI32)0));
 result=((NI)(T6_));
 }BeforeRet_: ;
 return result;}
...
{nimErr_=nimErrorFlag();
 ...
 LA4_: ;
 {
  ...
  if(NIM_UNLIKELY(*nimErr_))goto BeforeRet_;
  raiseOSError__CWyPYlyH9a6rAuZckFyVxPA(T10_,((NimStringDesc*)&TM__XqsrSBxhOTPgLQ9cX4MmV4A_30));
  if(NIM_UNLIKELY(*nimErr_))goto BeforeRet_;
 }
 LA8_: ;
 }BeforeRet_: ;}
...
appendString(T24_,((NimStringDesc*)&TM__XqsrSBxhOTPgLQ9cX4MmV4A_32));
  ...
  LA21_: ;
  {
   ...
   LA32_: ;
   sslPending=Dl_17295726_((*socket_0).sslHandle);
   {
...
{ result=(NI)0;
 result=((NI)0);
 {
  ...
  Dl_17305632_();
  T5_=(int)0;
  T5_=Dl_17295709_((*socket_0).sslHandle,buffer,((NI)(size)));
  result=((NI)(T5_));
  goto BeforeRet_;
 }
 LA3_: ;
 T6_=(int)0;
 T6_=Dl_14078320_((*socket_0).fd,buffer,size,flags);
 result=((NI)(T6_));
 goto BeforeRet_;
 }BeforeRet_: ;
 return result;}
...
{nimErr_=nimErrorFlag();
 ...
 LA7_: ;
 {
  ...
  LA40_: ;
  {
   int T54_;
   T54_=(int)0;
   T54_=Dl_14078320_((*socket_0).fd,data,((int)(size)),((NI32)0));
   result=((NI)(T54_));
  }
  LA38_: ;
  {
   ...
   T59_=(NI32)0;
   T59_=osLastError__9bUWNxbcGnToMWA9b79aTXLIw();
   if(NIM_UNLIKELY(*nimErr_))goto BeforeRet_;
   (*socket_0).lastError=T59_;
  }
  LA57_: ;
 }
 LA5_: ;
...
{nimErr_=nimErrorFlag();
 ...
 LA3_: ;
 {
  ...
  LA18_: ;
  T25_=(int)0;
  T25_=Dl_14078320_((*socket_0).fd,((void*)(c)),((int)1),((int)2));
  result=((NI)(T25_));
 }
 LA1_: ;
 }BeforeRet_: ;
...
{nimErr_=nimErrorFlag();
 ...
 (*line)= setLengthStr((*line),((NI)0));
 {
  while(1){
   ...
   c=(NIM_CHAR)0;
   T3_=(NI)0;
   T3_=waitFor__mpNV4IG56MRYASsne34FNA(socket_0,(&waited),timeout,((NI)1),((NimStringDesc*)&TM__XqsrSBxhOTPgLQ9cX4MmV4A_33));
   if(NIM_UNLIKELY(*nimErr_))goto BeforeRet_;
   (void)(T3_);
   ...
   LA4_: ;
   {
    ...
    T20_=(NI)0;
    T20_=waitFor__mpNV4IG56MRYASsne34FNA(socket_0,(&waited),timeout,((NI)1),((NimStringDesc*)&TM__XqsrSBxhOTPgLQ9cX4MmV4A_33));
    if(NIM_UNLIKELY(*nimErr_))goto BeforeRet_;
    (void)(T20_);
...
{nimErr_=nimErrorFlag();
 ...
 read=((NI)0);
 {
  while(1){
   ...
   avail=waitFor__mpNV4IG56MRYASsne34FNA(socket_0,(&waited),timeout,(NI)(size-read),((NimStringDesc*)&TM__XqsrSBxhOTPgLQ9cX4MmV4A_35));
   if(NIM_UNLIKELY(*nimErr_))goto BeforeRet_;
   d=((NCSTRING)(data));
...
{nimErr_=nimErrorFlag();
 result=(int)0;
 {
  ...
  LA5_: ;
  if(!T3_)goto LA7_;
  result=Dl_17305414_(ctx,((int)94),onoff,NIM_NIL);
 }
 goto LA1_;
 LA7_: ;
 {
...
appendString(T18_,keyFile);
 ...
 LA15_: ;
 {
  ...
  ret=Dl_17295664_(ctx,nimToCStringConv(certFile));
  {
 ...
 LA21_: ;
 {
  if(!!(((keyFile ? keyFile->Sup.len : 0)== 0)))goto LA29_;
  {
   int T33_;
   T33_=(int)0;
   T33_=Dl_17295668_(ctx,nimToCStringConv(keyFile),((int)1));
...
{nimErr_=nimErrorFlag();
 ...
 }
 {
  int T9_;
  T9_=(int)0;
  T9_=Dl_17295655_(newCTX,nimToCStringConv(cipherList));
 ...
 LA26_: ;
 Dl_17295643_(newCTX,((NI)0),NIM_NIL);
 {
...
static TNimNode* TM__XqsrSBxhOTPgLQ9cX4MmV4A_18_16[16];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_18_16[0]=&TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[15];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_18_16[1]=&TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[16];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_18_16[2]=&TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[17];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_18_16[3]=&TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[18];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_18_16[4]=&TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[19];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_18_16[5]=&TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[20];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_18_16[6]=&TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[21];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_18_16[7]=&TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[22];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_18_16[8]=&TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[23];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_18_16[9]=&TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[24];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_18_16[10]=&TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[25];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_18_16[11]=&TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[26];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_18_16[12]=&TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[27];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_18_16[13]=&TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[28];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_18_16[14]=&TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[29];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_18_16[15]=&TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[30];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[14].len=16;TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[14].kind=2;TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[14].sons=&TM__XqsrSBxhOTPgLQ9cX4MmV4A_18_16[0];
