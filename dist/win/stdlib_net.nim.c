...
/* Command for C compiler:
   /usr/bin/x86_64-w64-mingw32-gcc -c  -w -mno-ms-bitfields -DWIN32_LEAN_AND_MEAN   -I/home/juan/.choosenim/toolchains/nim-1.2.0/lib -I/home/juan/code/faster-than-csv/src -o /home/juan/code/faster-than-csv/dist/win/stdlib_net.nim.c.o /home/juan/code/faster-than-csv/dist/win/stdlib_net.nim.c */
...
N_LIB_PRIVATE N_NIMCALL(void, socketError__Ue4MZTG7GdQcQTXPPoMb1Q)(tyObject_SocketImpl__aIhANOOoETolVz9cccNO9cRQ* socket_0, NI err, NIM_BOOL async, NI32 lastError);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isClosed__lkWsihqFnPzvxMAQnry9aJQ)(tyObject_SocketImpl__aIhANOOoETolVz9cccNO9cRQ* socket_0);
...
"ype \'IpAddress\'", 78);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_85, "net.nim(1444, 9) `not socket.isClosed` Cannot `send` on a close"
"d socket", 71);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_86, "Could not send all data.", 24);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_87, "net.nim(1190, 24) `false` ", 26);
N_LIB_PRIVATE TNimType NTI__YJ9a3zV3oEciJsNBlUEYRfw_;
N_LIB_PRIVATE TNimType NTI__DtrJpMCrh4f9cUcHkEf48kQ_;
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_90, "Call to \'", 9);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_91, "\' timed out.", 12);
extern TNimType NTI__qwqHTkRvwhrRyENtudHQ7g_;
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_93, "readLine", 8);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_94, "net.nim(1107, 9) `not socket.isClosed` Cannot `recv` on a close"
"d socket", 71);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_98, "net.nim(1154, 14) `size - read >= chunk` ", 41);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_105, "\015\012", 2);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_107, "recv", 4);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_109, "net.nim(1225, 12) `avail <= size - read` ", 41);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_111, "SSLv2 is no longer secure and has been deprecated, use protSSLv"
"23", 65);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_112, "SSLv3 is no longer secure and has been deprecated, use protSSLv"
"23", 65);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_113, "Certificate file could not be found: ", 37);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_114, "Key file could not be found: ", 29);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_115, "Verification of private key file failed.", 40);
extern tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_40166214_;
extern TSafePoint* excHandler__rqLlY5bs9atDw2OXYqJEn5g;
extern TSafePoint* excHandler__rqLlY5bs9atDw2OXYqJEn5g;
extern tyProc__ln4kdL5W9bbX4a1xl8nnVXQ Dl_40175612_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_40166296_;
extern tyProc__kxUw9cdxJbPtv0iPyoSbDBQ Dl_40166319_;
extern tyProc__cez8YhJI0vaCUcjGg6z4zA Dl_40166626_;
extern tyProc__S7DQYB5vODbZUsDBlWEW6g Dl_40166620_;
...
extern TFrame* framePtr__HRfVMH3jYeBJz6Q6X9b6Ptw;
extern TFrame* framePtr__HRfVMH3jYeBJz6Q6X9b6Ptw;
extern tyProc__e47RoMUolEGMiUlfiZt9abQ Dl_40166219_;
extern NI osInvalidSocket__voz9aUXu8jtRbvGZZJHNE8w;
extern tyProc__IV3cwg4tBg3JP8ITSKt7oQ Dl_37523456_;
extern tyProc__T129bsPZ4FvuSF4rGFSBKkg Dl_37523281_;
extern tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_40166216_;
extern tyProc__EJ9cbYwLVOng2t4wnewGkmA Dl_40166292_;
extern Exception* currException__9bVPeDJlYTi9bQApZpfH8wjg;
extern Exception* currException__9bVPeDJlYTi9bQApZpfH8wjg;
extern Exception* currException__9bVPeDJlYTi9bQApZpfH8wjg;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_40166306_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_40166323_;
extern tyProc__sG7rgqmtlgBaumPwwN3BfQ Dl_40166314_;
extern tyProc__4YBDaTH9b4xNNXSV9ahdJZ8w Dl_37523345_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_40166326_;
extern tyProc__09aW01hZ1tSPafLaWVpBcXA Dl_40166309_;
extern tyProc__4YBDaTH9b4xNNXSV9ahdJZ8w Dl_37523320_;
extern tyProc__Rqjya8uauy9aPcyfGamaSrg Dl_40166232_;
extern tyProc__HXibadfWHwHwyhCwpIRD2A Dl_40165649_;
extern tyProc__2PA7CxitARKs0jpUW1gQ0g Dl_40166255_;
extern tyProc__H5wL7jexPlRA7WCw9cqLm0A Dl_40166243_;
extern tyProc__tYatIIo0oRSB9bjHLep7yhQ Dl_40166264_;
extern tyProc__xjxKRHVZXDqdWXw9bunoZ3w Dl_40166268_;
extern tyProc__Vff1ipOwDPDGknaRJAdXjA Dl_40166273_;
static N_NIMCALL(void, Marker_tyRef__t2PQ49cw9cyPD5BKolxzFbTw)(void* p, NI op) {
...
{	nimln_(800, "net.nim");
	{
		...
		nimln_(801, "net.nim");
		{
			...
			ret = Dl_40166319_((*socket_0).sslHandle, ((int) (err)));
			nimln_(803, "net.nim");
			switch (ret) {
			case ((NI) 6):
			{
...
appendString(errStr, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_15));
				...
				LA33_: ;
				{
					...
					nimln_(824, "net.nim");
					T36_ = (NCSTRING)0;
					T36_ = Dl_40166620_(sslErr, NIM_NIL);
...
appendString(T37_, errStr_2);
	...
	nimln_(832, "net.nim");
	{
		...
		nimln_(834, "net.nim");
		{
			...
			nimln_(836, "net.nim");
			{
				if (!(lastE == ((NI32) 10035))) goto LA57_;
				nimln_(837, "net.nim");
				goto BeforeRet_;
			}
			goto LA55_;
...
N_LIB_PRIVATE N_NIMCALL(void, close__UCnvqeCP6HY9ax9cmybKvMtw)(tyObject_SocketImpl__aIhANOOoETolVz9cccNO9cRQ* socket_0) {
	...
	if (TM__XqsrSBxhOTPgLQ9cX4MmV4A_7.status == 0) {
		nimln_(982, "net.nim");
		{
			...
			Dl_40175612_();
			nimln_(988, "net.nim");
			res = Dl_40166296_((*socket_0).sslHandle);
			nimln_(989, "net.nim");
			{
			...
			LA10_: ;
			{
				...
				nimln_(992, "net.nim");
				socketError__Ue4MZTG7GdQcQTXPPoMb1Q(socket_0, ((NI) (res)), NIM_FALSE, ((NI32) -1));
			}
			goto LA8_;
			LA13_: ;
			LA8_: ;
	...
	}
	{
		nimln_(995, "net.nim");
		{
			...
			T19_ = (*socket_0).isSsl;
			if (!(T19_)) goto LA20_;
			T19_ = !(((*socket_0).sslHandle == NIM_NIL));
			LA20_: ;
			if (!T19_) goto LA21_;
			nimln_(996, "net.nim");
			Dl_40166219_((*socket_0).sslHandle);
			nimln_(997, "net.nim");
		...
		while (1) {
			if (!!((it == NIM_NIL))) goto LA5;
			{
				...
				nimln_(1674, "net.nim");
				{
					...
					nimln_(1675, "net.nim");
					lastFd = createNativeSocket__gleglXd7KAwoHftHpflBnA(domain, sockType, protocol);
					nimln_(1676, "net.nim");
					{
						NI32 err;
				...
				nimln_(1685, "net.nim");
				{
					int T39_;
					T39_ = (int)0;
					T39_ = Dl_37523281_(lastFd, (*it).ai_addr, ((unsigned int) ((*it).ai_addrlen)));
...
N_LIB_PRIVATE N_NIMCALL(void, wrapSocket__nSrKttw9bOstnCyvh66mpmQ)(tyObject_SslContextcolonObjectType___nNdejAl9bbVbX7sP6RJ4h0w* ctx, tyObject_SocketImpl__aIhANOOoETolVz9cccNO9cRQ* socket_0) {
	...
	nimln_(694, "net.nim");
	(*socket_0).sslHandle = Dl_40166216_((*(*socket_0).sslContext).context);
	nimln_(695, "net.nim");
	...
	nimln_(697, "net.nim");
	{
		if (!((*socket_0).sslHandle == NIM_NIL)) goto LA7_;
		nimln_(698, "net.nim");
		raiseSSLError__4bk00w9al9cfmeFR9a9cMW860g(((NimStringDesc*) NIM_NIL));
	}
	LA7_: ;
	nimln_(700, "net.nim");
	{
		int T11_;
		T11_ = (int)0;
		T11_ = Dl_40166292_((*socket_0).sslHandle, (*socket_0).fd);
...
N_LIB_PRIVATE N_NIMCALL(void, wrapConnectedSocket__zB421aJ04hXbpUeGq3doVQ)(tyObject_SslContextcolonObjectType___nNdejAl9bbVbX7sP6RJ4h0w* ctx, tyObject_SocketImpl__aIhANOOoETolVz9cccNO9cRQ* socket_0, tyEnum_SslHandshakeType__9aZhh5f9bRDKgYB8GLASDSqg handshake, NimStringDesc* hostname) {
	...
	case ((tyEnum_SslHandshakeType__9aZhh5f9bRDKgYB8GLASDSqg) 0):
	{
		...
		LA7_: ;
		nimln_(742, "net.nim");
		ret = Dl_40166306_((*socket_0).sslHandle);
		nimln_(743, "net.nim");
		socketError__Ue4MZTG7GdQcQTXPPoMb1Q(socket_0, ((NI) (ret)), NIM_FALSE, ((NI32) -1));
	}
	break;
	case ((tyEnum_SslHandshakeType__9aZhh5f9bRDKgYB8GLASDSqg) 1):
	{
		int ret_2;
		nimln_(748, "net.nim");
		ret_2 = Dl_40166323_((*socket_0).sslHandle);
		nimln_(749, "net.nim");
		socketError__Ue4MZTG7GdQcQTXPPoMb1Q(socket_0, ((NI) (ret_2)), NIM_FALSE, ((NI32) -1));
	}
	break;
	}
	popFrame();
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isClosed__lkWsihqFnPzvxMAQnry9aJQ)(tyObject_SocketImpl__aIhANOOoETolVz9cccNO9cRQ* socket_0) {
	...
	result = (NIM_BOOL)0;
	nimln_(1099, "net.nim");
	result = ((*socket_0).fd == osInvalidSocket__voz9aUXu8jtRbvGZZJHNE8w);
	popFrame();
	return result;
}
N_LIB_PRIVATE N_NIMCALL(NI, send__5L0SyQu9bf9aWLpivLtuRdDg)(tyObject_SocketImpl__aIhANOOoETolVz9cccNO9cRQ* socket_0, void* data, NI size) {
...
{	result = (NI)0;
	nimln_(1444, "net.nim");
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = isClosed__lkWsihqFnPzvxMAQnry9aJQ(socket_0);
		if (!!(!(T3_))) goto LA4_;
	...
	nimln_(1446, "net.nim");
	{
		...
		nimln_(1447, "net.nim");
		T10_ = (int)0;
		T10_ = Dl_40166314_((*socket_0).sslHandle, ((NCSTRING) (data)), size);
		result = ((NI) (T10_));
		goto BeforeRet_;
	}
	LA8_: ;
	...
	T11_ = (int)0;
	T11_ = Dl_37523345_((*socket_0).fd, data, ((int) (size)), ((NI32) 0));
	result = ((NI) (T11_));
	}BeforeRet_: ;
	popFrame();
	return result;
...
N_LIB_PRIVATE N_NIMCALL(void, send__sP9af4zGpnwmZkRofZDfbQQ)(tyObject_SocketImpl__aIhANOOoETolVz9cccNO9cRQ* socket_0, NimStringDesc* data, tySet_tyEnum_SocketFlag__4xio0cAXR7XG4pF9bVcpxEg flags) {
	...
	nimfr_("send", "net.nim");
{	nimln_(1459, "net.nim");
	sent = send__5L0SyQu9bf9aWLpivLtuRdDg(socket_0, ((void*) (nimToCStringConv(data))), (data ? data->Sup.len : 0));
	nimln_(1460, "net.nim");
	{
		NI32 lastError;
		...
		LA8_: ;
		nimln_(1463, "net.nim");
		socketError__Ue4MZTG7GdQcQTXPPoMb1Q(socket_0, ((NI) -1), NIM_FALSE, lastError);
	}
	LA3_: ;
	nimln_(1465, "net.nim");
	{
		...
		raiseOSError__CWyPYlyH9a6rAuZckFyVxPA(T14_, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_86));
	}
	LA12_: ;
	}BeforeRet_: ;
	popFrame();
...
{	result = (NI)0;
	...
	nimln_(1190, "net.nim");
	{
		...
		nimln_(1190, "net.nim");
		{
			...
			failedAssertImpl__W9cjVocn1tjhW7p7xohJj6A(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_87));
		}
		LA7_: ;
	}
	LA3_: ;
	...
	nimln_(1192, "net.nim");
	{
		...
		if (!T15_) goto LA19_;
		nimln_(1194, "net.nim");
		if (nimSubInt((*socket_0).bufLen, (*socket_0).currPos, &TM__XqsrSBxhOTPgLQ9cX4MmV4A_88)) { raiseOverflow(); };
		result = (NI)(TM__XqsrSBxhOTPgLQ9cX4MmV4A_88);
		nimln_(1195, "net.nim");
	...
	LA19_: ;
	{
		...
		{
			NI64 T24_;
			NI64 TM__XqsrSBxhOTPgLQ9cX4MmV4A_89;
			tyObject_TimeoutError__YJ9a3zV3oEciJsNBlUEYRfw* T27_;
			NimStringDesc* T28_;
			T24_ = (NI64)0;
			T24_ = inMilliseconds__df0d89cDnRIju9aB6p1W1qVA((*waited));
			if (nimSubInt64(((NI64) (timeout)), T24_, &TM__XqsrSBxhOTPgLQ9cX4MmV4A_89)) { raiseOverflow(); };
			if (!((NI64)(TM__XqsrSBxhOTPgLQ9cX4MmV4A_89) < IL64(1))) goto LA25_;
...
appendString(T28_, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_91));
		...
		nimln_(1201, "net.nim");
		{
			...
			nimln_(1202, "net.nim");
			{
				NIM_BOOL T35_;
				T35_ = (NIM_BOOL)0;
				T35_ = hasDataBuffered__L6V0D3apf5iJeZChqzkovw(socket_0);
				if (!T35_) goto LA36_;
				nimln_(1204, "net.nim");
				result = ((NI) 1);
				goto BeforeRet_;
			...
			LA36_: ;
			nimln_(1205, "net.nim");
			sslPending = Dl_40166326_((*socket_0).sslHandle);
			nimln_(1206, "net.nim");
			{
		...
		if (nimSubInt64(((NI64) (timeout)), T42_, &TM__XqsrSBxhOTPgLQ9cX4MmV4A_92)) { raiseOverflow(); };
		selRet = select__9c4QMA6DGRJbXBL6Jy4sbPw(socket_0, ((NI) ((NI64)(TM__XqsrSBxhOTPgLQ9cX4MmV4A_92))));
		nimln_(1211, "net.nim");
		{
			NI32 T47_;
...
{	result = (NI)0;
	...
	nimln_(1109, "net.nim");
	{
		...
		nimln_(1110, "net.nim");
		T10_ = (int)0;
		T10_ = Dl_40166309_((*socket_0).sslHandle, buffer, ((NI) (size)));
		result = ((NI) (T10_));
		goto BeforeRet_;
	}
	LA8_: ;
	nimln_(1112, "net.nim");
	T11_ = (int)0;
	T11_ = Dl_37523320_((*socket_0).fd, buffer, size, flags);
	result = ((NI) (T11_));
	goto BeforeRet_;
	}BeforeRet_: ;
	popFrame();
...
{	result = (NI)0;
	...
	result = ((NI) 0);
	nimln_(1116, "net.nim");
	result = uniRecv__YQlV9aRgVr9cJoVJlEPDJIqw(socket_0, ((void*) ((*socket_0).buffer)), ((int) 4000), flags);
	nimln_(1117, "net.nim");
	{
...
{	result = (NI)0;
	...
	nimln_(1143, "net.nim");
	{
		...
		read = ((NI) 0);
		{
			...
			while (1) {
				...
				LA26_: ;
				nimln_(1152, "net.nim");
				if (nimSubInt((*socket_0).bufLen, (*socket_0).currPos, &TM__XqsrSBxhOTPgLQ9cX4MmV4A_95)) { raiseOverflow(); };
				if (nimSubInt(size, read, &TM__XqsrSBxhOTPgLQ9cX4MmV4A_96)) { raiseOverflow(); };
				chunk = (((NI)(TM__XqsrSBxhOTPgLQ9cX4MmV4A_95) <= (NI)(TM__XqsrSBxhOTPgLQ9cX4MmV4A_96)) ? (NI)(TM__XqsrSBxhOTPgLQ9cX4MmV4A_95) : (NI)(TM__XqsrSBxhOTPgLQ9cX4MmV4A_96));
				nimln_(1153, "net.nim");
				d = ((NCSTRING) (data));
				nimln_(1154, "net.nim");
				{
					...
					if (!!((chunk <= (NI)(TM__XqsrSBxhOTPgLQ9cX4MmV4A_97)))) goto LA39_;
					failedAssertImpl__W9cjVocn1tjhW7p7xohJj6A(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_98));
				}
				LA39_: ;
				nimln_(1155, "net.nim");
				...
				nimln_(1156, "net.nim");
				if (nimAddInt(read, chunk, &TM__XqsrSBxhOTPgLQ9cX4MmV4A_99)) { raiseOverflow(); };
				read = (NI)(TM__XqsrSBxhOTPgLQ9cX4MmV4A_99);
				nimln_(1157, "net.nim");
				if (nimAddInt((*socket_0).currPos, chunk, &TM__XqsrSBxhOTPgLQ9cX4MmV4A_100)) { raiseOverflow(); };
				(*socket_0).currPos = (NI)(TM__XqsrSBxhOTPgLQ9cX4MmV4A_100);
			} LA23: ;
		}
		nimln_(1159, "net.nim");
		result = read;
	...
	LA7_: ;
	{
		nimln_(1162, "net.nim");
		{
			...
			nimln_(1163, "net.nim");
			{
				...
				nimln_(1166, "net.nim");
				{
					...
					if (nimSubInt(size, ((NI) 1), &TM__XqsrSBxhOTPgLQ9cX4MmV4A_101)) { raiseOverflow(); };
					if (!(((NI) 0) < (NI)(TM__XqsrSBxhOTPgLQ9cX4MmV4A_101))) goto LA52_;
					nimln_(1167, "net.nim");
					d_2 = ((NCSTRING) (data));
					nimln_(1168, "net.nim");
					if (nimSubInt(size, ((NI) 1), &TM__XqsrSBxhOTPgLQ9cX4MmV4A_102)) { raiseOverflow(); };
					if (((NI)(TM__XqsrSBxhOTPgLQ9cX4MmV4A_102)) < ((int) (-2147483647 -1)) || ((NI)(TM__XqsrSBxhOTPgLQ9cX4MmV4A_102)) > ((int) 2147483647)){ raiseRangeErrorI((NI)(TM__XqsrSBxhOTPgLQ9cX4MmV4A_102), ((int) (-2147483647 -1)), ((int) 2147483647)); }
					T54_ = (NI)0;
					T54_ = uniRecv__YQlV9aRgVr9cJoVJlEPDJIqw(socket_0, ((void*) ((&d_2[((NI) 1)]))), ((int) ((NI)(TM__XqsrSBxhOTPgLQ9cX4MmV4A_102))), ((NI32) 0));
					if (nimAddInt(T54_, ((NI) 1), &TM__XqsrSBxhOTPgLQ9cX4MmV4A_103)) { raiseOverflow(); };
					result = (NI)(TM__XqsrSBxhOTPgLQ9cX4MmV4A_103);
				}
				goto LA50_;
				LA52_: ;
				{
		...
		LA44_: ;
		{
			...
			if ((size) < ((int) (-2147483647 -1)) || (size) > ((int) 2147483647)){ raiseRangeErrorI(size, ((int) (-2147483647 -1)), ((int) 2147483647)); }
			T58_ = (int)0;
			T58_ = Dl_37523320_((*socket_0).fd, data, ((int) (size)), ((NI32) 0));
			result = ((NI) (T58_));
		}
		LA42_: ;
		nimln_(1177, "net.nim");
...
{	result = (NI)0;
	nimln_(1297, "net.nim");
	{
		...
		nimln_(1299, "net.nim");
		{
			...
			if (T7_) goto LA8_;
			if (nimSubInt((*socket_0).bufLen, ((NI) 1), &TM__XqsrSBxhOTPgLQ9cX4MmV4A_104)) { raiseOverflow(); };
			T7_ = ((NI)(TM__XqsrSBxhOTPgLQ9cX4MmV4A_104) < (*socket_0).currPos);
			LA8_: ;
			if (!T7_) goto LA9_;
			nimln_(1300, "net.nim");
			res = readIntoBuf__3VtccBbq17lyKCft9aSHtGA(socket_0, ((NI32) 0));
	...
	LA3_: ;
	{
		...
		nimln_(1307, "net.nim");
		{
			...
			nimln_(1308, "net.nim");
			{
				...
				nimln_(1309, "net.nim");
				result = uniRecv__YQlV9aRgVr9cJoVJlEPDJIqw(socket_0, ((void*) ((&(*socket_0).sslPeekChar))), ((int) 1), ((NI32) 0));
				nimln_(1310, "net.nim");
		...
		nimln_(1314, "net.nim");
		T24_ = (int)0;
		T24_ = Dl_37523320_((*socket_0).fd, ((void*) (c)), ((int) 1), ((int) 2));
		result = ((NI) (T24_));
	}
	LA1_: ;
	}BeforeRet_: ;
...
{	nimZeroMem((void*)(&waited), sizeof(tyObject_Duration__lj9ar6Co3fgk6NgGnVaNpJw));
	...
	(*line) = setLengthStr((*line), ((NI) 0));
	{
		...
		while (1) {
			...
			nimln_(1351, "net.nim");
			T3_ = (NI)0;
			T3_ = waitFor__mpNV4IG56MRYASsne34FNA(socket_0, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_93));
			(void)(T3_);
			nimln_(1352, "net.nim");
			...
			nimln_(1353, "net.nim");
			{
				...
				LA11_: ;
				nimln_(1344, "net.nim");
				socketError__Ue4MZTG7GdQcQTXPPoMb1Q(socket_0, n, NIM_FALSE, lastError);
			}
			goto LA4_;
			LA6_: ;
			{
			...
			nimln_(1355, "net.nim");
			{
				...
				nimln_(1356, "net.nim");
				T20_ = (NI)0;
				T20_ = waitFor__mpNV4IG56MRYASsne34FNA(socket_0, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_93));
				(void)(T20_);
				nimln_(1357, "net.nim");
				...
				LA25_: ;
				{
					...
					LA34_: ;
					nimln_(1344, "net.nim");
					socketError__Ue4MZTG7GdQcQTXPPoMb1Q(socket_0, n, NIM_FALSE, lastError_2);
				}
				goto LA21_;
				LA29_: ;
				LA21_: ;
...
appendString((*line), ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_105));
				}
				LA38_: ;
				nimln_(1362, "net.nim");
				goto BeforeRet_;
...
{	result = (NI)0;
	...
	read = ((NI) 0);
	{
		...
		while (1) {
			...
			nimln_(1223, "net.nim");
			if (nimSubInt(size, read, &TM__XqsrSBxhOTPgLQ9cX4MmV4A_106)) { raiseOverflow(); };
			avail = waitFor__mpNV4IG56MRYASsne34FNA(socket_0, (&waited), timeout, (NI)(TM__XqsrSBxhOTPgLQ9cX4MmV4A_106), ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_107));
			nimln_(1224, "net.nim");
			d = ((NCSTRING) (data));
			nimln_(1225, "net.nim");
			{
				NI TM__XqsrSBxhOTPgLQ9cX4MmV4A_108;
				if (nimSubInt(size, read, &TM__XqsrSBxhOTPgLQ9cX4MmV4A_108)) { raiseOverflow(); };
				if (!!((avail <= (NI)(TM__XqsrSBxhOTPgLQ9cX4MmV4A_108)))) goto LA5_;
				failedAssertImpl__W9cjVocn1tjhW7p7xohJj6A(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_109));
			}
			LA5_: ;
			nimln_(1226, "net.nim");
			...
			LA13_: ;
			nimln_(1230, "net.nim");
			if (nimAddInt(read, result, &TM__XqsrSBxhOTPgLQ9cX4MmV4A_110)) { raiseOverflow(); };
			read = (NI)(TM__XqsrSBxhOTPgLQ9cX4MmV4A_110);
		} LA2: ;
	} LA1: ;
	nimln_(1232, "net.nim");
	result = read;
...
{	result = (NI)0;
	...
	nimln_(1264, "net.nim");
	{
		...
		LA13_: ;
		nimln_(1268, "net.nim");
		socketError__Ue4MZTG7GdQcQTXPPoMb1Q(socket_0, result, NIM_FALSE, lastError);
	}
	LA8_: ;
	nimln_(1269, "net.nim");
...
appendString(T9_, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_113));
...
appendString(T18_, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_114));
appendString(T18_, keyFile);
	...
	nimln_(508, "net.nim");
	{
		...
		nimln_(509, "net.nim");
		ret = Dl_40166264_(ctx, nimToCStringConv(certFile));
		nimln_(510, "net.nim");
		{
	...
	nimln_(514, "net.nim");
	{
		...
		nimln_(515, "net.nim");
		{
			...
			nimln_(515, "net.nim");
			T33_ = (int)0;
			T33_ = Dl_40166268_(ctx, nimToCStringConv(keyFile), ((int) 1));
...
N_LIB_PRIVATE N_NIMCALL(tyObject_SslContextcolonObjectType___nNdejAl9bbVbX7sP6RJ4h0w*, newContext__p45vOS9b3iK2JJ1Y7aIJ9bUA)(tyEnum_SslProtVersion__zq9bkhgPAE6ngdz7HLdOTDw protVersion, tyEnum_SslCVerifyMode__t9a9cuHiKUd7w4o8XPQAbfJg verifyMode, NimStringDesc* certFile, NimStringDesc* keyFile, NimStringDesc* cipherList, NimStringDesc* caDir, NimStringDesc* caFile) {
	...
	nimln_(567, "net.nim");
	{
		int T9_;
		T9_ = (int)0;
		T9_ = Dl_40166255_(newCTX, nimToCStringConv(cipherList));
	...
	LA10_: ;
	nimln_(571, "net.nim");
	Dl_40166243_(newCTX, ((NI) 0), NIM_NIL);
	nimln_(579, "net.nim");
	{
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[15].typ = (&NTI__rR5Bzr1D5krxoo1NcNyeMA_);
