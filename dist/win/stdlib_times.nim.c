...
/* Command for C compiler:
   /usr/bin/x86_64-w64-mingw32-gcc -c  -w -mno-ms-bitfields -DWIN32_LEAN_AND_MEAN   -I/home/juan/.choosenim/toolchains/nim-1.2.0/lib -I/home/juan/code/faster-than-csv/src -o /home/juan/code/faster-than-csv/dist/win/stdlib_times.nim.c.o /home/juan/code/faster-than-csv/dist/win/stdlib_times.nim.c */
...
N_LIB_PRIVATE N_NIMCALL(NI64, inMilliseconds__df0d89cDnRIju9aB6p1W1qVA)(tyObject_Duration__lj9ar6Co3fgk6NgGnVaNpJw dur) {
	NI64 result;
	NIM_BOOL correctionX60gensym37620230_;
	NIM_BOOL T1_;
	...
	LA2_: ;
	correctionX60gensym37620230_ = T1_;
	nimln_(519, "times.nim");
	{
		...
		if (!correctionX60gensym37620230_) goto LA5_;
		nimln_(520, "times.nim");
...
N_LIB_PRIVATE N_NIMCALL(tyObject_Duration__lj9ar6Co3fgk6NgGnVaNpJw, initDuration__wcR3zetvspAUsyuvWZ07Xg)(NI64 nanoseconds, NI64 microseconds, NI64 milliseconds, NI64 seconds, NI64 minutes, NI64 hours, NI64 days, NI64 weeks) {
	...
	nimZeroMem((void*)(&result), sizeof(tyObject_Duration__lj9ar6Co3fgk6NgGnVaNpJw));
	nimln_(494, "times.nim");
	nimln_(500, "times.nim");
	nimln_(499, "times.nim");
	nimln_(498, "times.nim");
	nimln_(497, "times.nim");
	nimln_(496, "times.nim");
	nimln_(495, "times.nim");
	nimln_(494, "times.nim");
	T1_ = (NI64)0;
...
N_LIB_PRIVATE N_NIMCALL(NI64, inSeconds__df0d89cDnRIju9aB6p1W1qVA_2)(tyObject_Duration__lj9ar6Co3fgk6NgGnVaNpJw dur) {
	NI64 result;
	NIM_BOOL correctionX60gensym37605230_;
	NIM_BOOL T1_;
	...
	T1_ = (((NI) 0) < ((NI) (dur.nanosecond)));
	LA2_: ;
	correctionX60gensym37605230_ = T1_;
	nimln_(517, "times.nim");
	if (nimAddInt64(dur.seconds, ((NI64) (correctionX60gensym37605230_)), &TM__6NbDwwj5FY059b1gz2AsAZQ_40)) { raiseOverflow(); };
