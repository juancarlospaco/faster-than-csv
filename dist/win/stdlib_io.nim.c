...
/* Command for C compiler:
   /usr/bin/x86_64-w64-mingw32-gcc -c  -w -mno-ms-bitfields -DWIN32_LEAN_AND_MEAN   -I/home/juan/.choosenim/toolchains/nim-1.2.0/lib -I/home/juan/code/faster-than-csv/src -o /home/juan/code/faster-than-csv/dist/win/stdlib_io.nim.c.o /home/juan/code/faster-than-csv/dist/win/stdlib_io.nim.c */
...
STRING_LITERAL(TM__MnCJ0VAmeZ9aTATUB39cx60Q_29, "cannot open: ", 13);
	...
	i = fprintf(f, "%s", nimToCStringConv(s));
	{
		while (1) {
			...
			LA5_: ;
			{
				...
				LA18_: ;
				if (nimAddInt(i, ((NI) (w_2)), &TM__MnCJ0VAmeZ9aTATUB39cx60Q_27)) { raiseOverflow(); };
				if (TM__MnCJ0VAmeZ9aTATUB39cx60Q_27 < (-2147483647 -1) || TM__MnCJ0VAmeZ9aTATUB39cx60Q_27 > 2147483647){ raiseOverflow(); }
				i = (int)(TM__MnCJ0VAmeZ9aTATUB39cx60Q_27);
			}
			LA3_: ;
		} LA2: ;
	} LA1: ;
	...
	nimfr_("echoBinSafe", "io.nim");
	{
		...
		i = ((NI) 0);
		{
			...
			while (1) {
				...
				if (nimAddInt(i, ((NI) 1), &TM__MnCJ0VAmeZ9aTATUB39cx60Q_28)) { raiseOverflow(); };
				i = (NI)(TM__MnCJ0VAmeZ9aTATUB39cx60Q_28);
			} LA3: ;
		}
	}
	nimln_(647, "io.nim");
...
appendString(T7_, ((NimStringDesc*) &TM__MnCJ0VAmeZ9aTATUB39cx60Q_29));
...
N_LIB_PRIVATE N_NIMCALL(void, writeFile__D6Pj9c29aCLEJP9beOWa08HYA)(NimStringDesc* filename, NimStringDesc* content) {
	...
	{
		NIM_BOOL T3_;
		TSafePoint TM__MnCJ0VAmeZ9aTATUB39cx60Q_30;
		T3_ = (NIM_BOOL)0;
		T3_ = open__gq12VLhVO0NBzUTnGgz4nw(&f, filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 1), ((NI) -1));
		if (!T3_) goto LA4_;
		nimln_(701, "io.nim");
		pushSafePoint(&TM__MnCJ0VAmeZ9aTATUB39cx60Q_30);
		TM__MnCJ0VAmeZ9aTATUB39cx60Q_30.status = setjmp(TM__MnCJ0VAmeZ9aTATUB39cx60Q_30.context);
		if (TM__MnCJ0VAmeZ9aTATUB39cx60Q_30.status == 0) {
			nimln_(702, "io.nim");
		...
		}
		{
			...
			if (TM__MnCJ0VAmeZ9aTATUB39cx60Q_30.status != 0) nimLeaveFinally();
		}
		if (TM__MnCJ0VAmeZ9aTATUB39cx60Q_30.status != 0) reraiseException();
	}
	goto LA1_;
	LA4_: ;
	{
...
appendString(T11_, ((NimStringDesc*) &TM__MnCJ0VAmeZ9aTATUB39cx60Q_29));
appendString(T11_, filename);
		(*T10_).Sup.Sup.message = T11_;
		(*T10_).Sup.Sup.parent = NIM_NIL;
		raiseExceptionEx((Exception*)T10_, "IOError", "writeFile", "io.nim", 706);
	}
	LA1_: ;
	popFrame();
}
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readFile__4PGnM9bWmsH0Nu7dnr3XzgA)(NimStringDesc* filename) {
	...
	{
		NIM_BOOL T3_;
		TSafePoint TM__MnCJ0VAmeZ9aTATUB39cx60Q_31;
		T3_ = (NIM_BOOL)0;
		T3_ = open__gq12VLhVO0NBzUTnGgz4nw(&f, filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 0), ((NI) -1));
		if (!T3_) goto LA4_;
		nimln_(688, "io.nim");
		pushSafePoint(&TM__MnCJ0VAmeZ9aTATUB39cx60Q_31);
		TM__MnCJ0VAmeZ9aTATUB39cx60Q_31.status = setjmp(TM__MnCJ0VAmeZ9aTATUB39cx60Q_31.context);
		if (TM__MnCJ0VAmeZ9aTATUB39cx60Q_31.status == 0) {
			nimln_(689, "io.nim");
		...
		}
		{
			nimln_(691, "io.nim");
			close__fU6ZlJAtQ9bre04EDZLdGsA(f);
			if (TM__MnCJ0VAmeZ9aTATUB39cx60Q_31.status != 0) nimLeaveFinally();
		}
		if (TM__MnCJ0VAmeZ9aTATUB39cx60Q_31.status != 0) reraiseException();
	}
	goto LA1_;
	LA4_: ;
	{
