...
/* Command for C compiler:
   /usr/bin/x86_64-w64-mingw32-gcc -c  -w -mno-ms-bitfields -DWIN32_LEAN_AND_MEAN   -I/home/juan/.choosenim/toolchains/nim-1.2.0/lib -I/home/juan/code/faster-than-csv/src -o /home/juan/code/faster-than-csv/dist/win/@m..@s..@s..@s.nimble@spkgs@snimpy-0.1.0@snimpy@spy_utils.nim.c.o /home/juan/code/faster-than-csv/dist/win/@m..@s..@s..@s.nimble@spkgs@snimpy-0.1.0@snimpy@spy_utils.nim.c */
...
N_LIB_PRIVATE N_NIMCALL(void, conversionToStringError__2YA4NXAzmPMdXt3hDLwaKQ)(void) {
	Exception* T1_;
	nimfr_("conversionToStringError", "py_utils.nim");
	nimln_(24, "py_utils.nim");
...
{	result = (NIM_BOOL)0;
	...
	LA27_: ;
	nimln_(49, "py_utils.nim");
	{
		if (!!((b == 0))) goto LA31_;
		nimln_(50, "py_utils.nim");
		decRef__CnqcscfOCAX2jCHv3dRPDw_2py_utils(b);
	}
	LA31_: ;
	nimln_(52, "py_utils.nim");
	result = NIM_TRUE;
	}BeforeRet_: ;
	popFrame();
	return result;
