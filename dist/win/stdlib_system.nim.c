...
STRING_LITERAL(TM__Q5wkpxktOdTGvlSRo9bzt9aw_20,"over- or underflow",18);
...
STRING_LITERAL(TM__Q5wkpxktOdTGvlSRo9bzt9aw_24,"invalid object assignment",25);
...
N_LIB_PRIVATE N_NOINLINE(void,raiseOverflow)(void){
 sysFatal__pO9abt7E7FWB3DInHeLgZeQsystem(((NimStringDesc*)&TM__Q5wkpxktOdTGvlSRo9bzt9aw_20));}
N_LIB_PRIVATE N_NIMCALL(void*,newSeq)(TNimType* typ,NI len){
 void* result;
 NI size;
 NI T1_;
...
{ result=(void*)0;
 ...
 if(nimAddInt(T1_,(NI)(TM__Q5wkpxktOdTGvlSRo9bzt9aw_19),&TM__Q5wkpxktOdTGvlSRo9bzt9aw_21)){ raiseOverflow();goto BeforeRet_;};
 size=(NI)(TM__Q5wkpxktOdTGvlSRo9bzt9aw_21);
...
{ result=(void*)0;
 T1_=(NI)0;
 T1_=align__vzThvqZajaR9ct9cQ7SOy1tQ(((NI)16),(*(*typ).base).align);
 if(nimMulInt(cap,(*(*typ).base).size,&TM__Q5wkpxktOdTGvlSRo9bzt9aw_22)){ raiseOverflow();goto BeforeRet_;};
 if(nimAddInt(T1_,(NI)(TM__Q5wkpxktOdTGvlSRo9bzt9aw_22),&TM__Q5wkpxktOdTGvlSRo9bzt9aw_23)){ raiseOverflow();goto BeforeRet_;};
 s=(NI)(TM__Q5wkpxktOdTGvlSRo9bzt9aw_23);
 {
...
static N_INLINE(void,chckObjAsgn)(TNimType* a,TNimType* b){
 {
  if(!!((a==b)))goto LA3_;
  sysFatal__LGIwiR9aqSM70ldGCThzJ3gsystem(((NimStringDesc*)&TM__Q5wkpxktOdTGvlSRo9bzt9aw_24));
 }
 LA3_: ;}
N_LIB_PRIVATE N_NIMCALL(void,genericAssignAux__U5DxFPRpHCCZDKWQzM9adaw)(void* dest,void* src,TNimType* mt,NIM_BOOL shallow){
 NI d;
...
NTI__cT9c9bHlHSpA1QTnKbHjnIkA_.node=&TM__Q5wkpxktOdTGvlSRo9bzt9aw_0[14];
...
NTI__9cxMi1BPLc3UKt9br86bGfGQ_.node=&TM__Q5wkpxktOdTGvlSRo9bzt9aw_0[15];
