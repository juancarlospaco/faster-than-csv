if (!((TM__k6kyf4Co79a84IkK9blFuQVA_8 = nimLoadLibrary(((NimStringDesc*) &TM__k6kyf4Co79a84IkK9blFuQVA_10)))
	...
	Dl_14071835_ = (tyProc__aO673xGTLLxou7P7GxoCXA) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_8, "FormatMessageW");
	Dl_14072001_ = (tyProc__im9buRnIvptJfzdASYMEbBA) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_8, "LocalFree");
	Dl_14071830_ = (tyProc__9bXer9a4ps9aSGctILcxWReVw) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_8, "GetLastError");
	Dl_14073260_ = (tyProc__9aO2cP4IgwjXF8JfUR57CHQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "socket");
	Dl_14073265_ = (tyProc__IQbFr9cLT9bipWCXYfwYwjOw) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "closesocket");
	Dl_14075067_ = (tyProc__m8OtNuKklv1X2vQjXQkzSA) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "WSAIoctl");
	Dl_14073563_ = (tyProc__uryidYWkntM7ddjZSyxvyQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_8, "GetCurrentProcess");
	Dl_14071557_ = (tyProc__C5kM33gEhlSKPXwfDNHofQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_8, "CreatePipe");
	Dl_14073558_ = (tyProc__mBVOPXmpGfUrrbA9a5K9cMbQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_8, "SetHandleInformation");
	Dl_14071565_ = (tyProc__ox3t5iM0vxm1voo9c2CrxLQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_8, "CreateNamedPipeW");
	Dl_14073565_ = (tyProc__A2Q4AG9aesAd2D8S5BP4y2g) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_8, "CreateFileW");
	Dl_14073543_ = (tyProc__oew1DfaGl5XhHmnBK0HYXQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_8, "DuplicateHandle");
	Dl_14071538_ = (tyProc__P13srMBg9b3d3yEV9aW4NCoA) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_8, "CloseHandle");
	Dl_14071820_ = (tyProc__zP2zGemcuVRvOUE82f9a0Pw) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_8, "GetStdHandle");
	Dl_14071587_ = (tyProc__hHrNIgHA5HNxhRfMx6QeWg) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_8, "CreateProcessW");
	Dl_14071541_ = (tyProc__9ajZYMGL5GqiRFqiCC367oA) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_8, "ReadFile");
	Dl_14071549_ = (tyProc__9ajZYMGL5GqiRFqiCC367oA) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_8, "WriteFile");
	Dl_14071807_ = (tyProc__FprzxJFfqQdWyyGxiUsmeQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_8, "WaitForSingleObject");
	Dl_14071815_ = (tyProc__KxeGXN001TReCr89ca9c5bng) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_8, "GetExitCodeProcess");
	Dl_14072456_ = (tyProc__lLim4ugM6CVjiaTaa7eXVA) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_8, "FindFirstFileW");
	Dl_14072614_ = (tyProc__ofoySXaAAlxxs9bQS9a1etlg) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_8, "FindClose");
	Dl_14073447_ = (tyProc__MvjKU9c5nvs0N3IrS4vNgSw) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "getaddrinfo");
	Dl_14073456_ = (tyProc__IV3cwg4tBg3JP8ITSKt7oQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "freeaddrinfo");
	Dl_14073281_ = (tyProc__T129bsPZ4FvuSF4rGFSBKkg) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "connect");
	Dl_14073345_ = (tyProc__4YBDaTH9b4xNNXSV9ahdJZ8w) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "send");
	Dl_14073336_ = (tyProc__rWrG4X5lbcXQyLNkF9aNWhQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "select");
	Dl_14073377_ = (tyProc__8Py1tJvU9bm83KdBcpIBjeQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "__WSAFDIsSet");
	Dl_14073320_ = (tyProc__4YBDaTH9b4xNNXSV9ahdJZ8w) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_3, "recv");
	Dl_14072624_ = (tyProc__2Dt6vzy4xOVEtn3qjtrTDQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_8, "GetFileAttributesW");
}
