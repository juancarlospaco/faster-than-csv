		...
		eolpos = ((NI) 0);
		{
			while (1) {
				...
				LA37_: ;
				{
					...
					X5BX5Deq___HfxZpUfki4UkuP38hbwROA(h, blitTmp, colontmpD__4);
					colontmpD__5 = lastUsedCode;
					add__MIAbjRZGBQlNfywJeCn8AQ((&result.data), colontmpD__5);
				}
				LA34_: ;
				{
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___XnnxnWxIcbyfm2N1q2H5wg)(tySequence__4CoKBAViiN2VV33Ov2SWmA* dest) {
 ...
 alignedDealloc((*dest).p, NIM_ALIGNOF(tyObject_Item__T8diAqAiCs9bhc5T1iInskQ));
}
}
