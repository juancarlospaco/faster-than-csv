...
/* Command for C compiler:
   gcc -c  -w -fmax-errors=3  -fPIC  -I'/home/juan/.choosenim/toolchains/nim-#devel/lib' -I/home/juan/code/faster-than-csv/src -o /home/juan/code/faster-than-csv/dist/lin/stdlib_parseutils.nim.c.o /home/juan/code/faster-than-csv/dist/lin/stdlib_parseutils.nim.c */
...
N_LIB_PRIVATE N_NIMCALL(NI, npuParseBiggestInt)(NimStringDesc* s, NI64* number, NI start) {
	...
	result = (NI)0;
	nimln_(446, "parseutils.nim");
	res = IL64(0);
	nimln_(449, "parseutils.nim");
	result = rawParseInt__oz568vhg7PZ19ak9aiwQxGYw(s, (&res), start);
	nimln_(450, "parseutils.nim");
	{
		if (!!((result == ((NI) 0)))) goto LA3_;
		nimln_(451, "parseutils.nim");
		(*number) = res;
	}
	LA3_: ;
	popFrame();
...
N_LIB_PRIVATE N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	res = IL64(0);
	nimln_(465, "parseutils.nim");
	result = npuParseBiggestInt(s, (&res), start);
	nimln_(469, "parseutils.nim");
	{
		if (!!((result == ((NI) 0)))) goto LA3_;
		nimln_(470, "parseutils.nim");
		(*number) = ((NI) (res));
	}
	LA3_: ;
	popFrame();
