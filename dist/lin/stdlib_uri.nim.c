...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___OydxUV9ad0I3qVcqasXV7RQ)(tyObject_Uri__j49bukNPrq747O1GRd4Ng9bQ* dest, tyObject_Uri__j49bukNPrq747O1GRd4Ng9bQ* src) {
	eqcopy___aBBXmHFBEivKqERloP6zmA_2((&(*dest).scheme), (*src).scheme);
	eqcopy___aBBXmHFBEivKqERloP6zmA_2((&(*dest).username), (*src).username);
	eqcopy___aBBXmHFBEivKqERloP6zmA_2((&(*dest).password), (*src).password);
	eqcopy___aBBXmHFBEivKqERloP6zmA_2((&(*dest).hostname), (*src).hostname);
	eqcopy___aBBXmHFBEivKqERloP6zmA_2((&(*dest).port), (*src).port);
	eqcopy___aBBXmHFBEivKqERloP6zmA_2((&(*dest).path), (*src).path);
	eqcopy___aBBXmHFBEivKqERloP6zmA_2((&(*dest).query), (*src).query);
	eqcopy___aBBXmHFBEivKqERloP6zmA_2((&(*dest).anchor), (*src).anchor);
