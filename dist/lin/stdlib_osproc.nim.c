...
{nimErr_ = nimErrorFlag();
	result = (tyObject_StreamObj__THYguAi9bSgidczZ3ywEIMQ*)0;
	{
		...
		T6_ = &T5_->Sup;
		eqsink___uD7PP9aMywYClkkmJVib7sg_2(&(*p).outStream, T6_);
	}
	LA3_: ;
	eq___uD7PP9aMywYClkkmJVib7sg(&result, (*p).outStream);
	goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	result = (tyObject_StreamObj__THYguAi9bSgidczZ3ywEIMQ*)0;
	{
		...
		T6_ = (tyObject_StreamObj__THYguAi9bSgidczZ3ywEIMQ*)0;
		T6_ = &T5_->Sup;
		eqsink___uD7PP9aMywYClkkmJVib7sg_2(&(*p).inStream, T6_);
	}
	LA3_: ;
	eq___uD7PP9aMywYClkkmJVib7sg(&result, (*p).inStream);
	goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
