...
extern NIM_CONST tyArray__nHXaesL0DJZHyVS07ARPRA ExeExts__ONrgkgAZ9bh6KVTWl4XeOSw;
...
} TM__HZdw8BhppcTQo8DIK46LSg_13 = { 42 | NIM_STRLIT_FLAG, "Could not find command: \'$1\'. OS error: $2" };
static const NimStringV2 TM__HZdw8BhppcTQo8DIK46LSg_14 = {42, (NimStrPayload*)&TM__HZdw8BhppcTQo8DIK46LSg_13};
static const struct {
  NI cap; NIM_CHAR data[1+1];
} TM__HZdw8BhppcTQo8DIK46LSg_15 = { 1 | NIM_STRLIT_FLAG, " " };
static const NimStringV2 TM__HZdw8BhppcTQo8DIK46LSg_16 = {1, (NimStrPayload*)&TM__HZdw8BhppcTQo8DIK46LSg_15};
static const NimStringV2 TM__HZdw8BhppcTQo8DIK46LSg_17 = {1, (NimStrPayload*)&TM__HZdw8BhppcTQo8DIK46LSg_15};
static const NimStringV2 TM__HZdw8BhppcTQo8DIK46LSg_18 = {0, (NimStrPayload*)&TM__HZdw8BhppcTQo8DIK46LSg_2};
static const struct {
  NI cap; NIM_CHAR data[0+1];
} TM__HZdw8BhppcTQo8DIK46LSg_19 = { 0 | NIM_STRLIT_FLAG, "" };
static const NimStringV2 TM__HZdw8BhppcTQo8DIK46LSg_20 = {0, (NimStrPayload*)&TM__HZdw8BhppcTQo8DIK46LSg_19};
static const struct {
  NI cap; NIM_CHAR data[1+1];
} TM__HZdw8BhppcTQo8DIK46LSg_21 = { 1 | NIM_STRLIT_FLAG, "\012" };
static const NimStringV2 TM__HZdw8BhppcTQo8DIK46LSg_22 = {1, (NimStrPayload*)&TM__HZdw8BhppcTQo8DIK46LSg_21};
...
N_LIB_PRIVATE N_NIMCALL(NCSTRING*, envToCStringArray__f7KyzfnKBI6fit7etE9c9aSA)(void) {
	...
	T8_ = (void*)0;
	T8_ = alloc0Impl__KzdpcuLT9aef9bsiSHlIu9aFg_2(((NI) ((NI)((NI)(counter + ((NI) 1)) * ((NI) 8)))));
	result = ((NCSTRING*) (T8_));
	i_2 = ((NI) 0);
	{
		NimStringV2 key_2;
...
N_LIB_PRIVATE N_NIMCALL(NCSTRING*, envToCStringArray__ycBq0pnoixEzCDQfJtZIrQ)(tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* t) {
	...
	T1_ = nstlen(t);
	T2_ = (void*)0;
	T2_ = alloc0Impl__KzdpcuLT9aef9bsiSHlIu9aFg_2(((NI) ((NI)((NI)(T1_ + ((NI) 1)) * ((NI) 8)))));
	result = ((NCSTRING*) (T2_));
	i = ((NI) 0);
	{
		NimStringV2 key;
...
{nimErr_ = nimErrorFlag();
	...
	(void)(T43_);
	{
		...
		exe = findExe__9cov9c3aI19bfbEIyMe9bNCSEA((*data).sysCommand, NIM_TRUE, ExeExts__ONrgkgAZ9bh6KVTWl4XeOSw, 1);
...
{nimErr_ = nimErrorFlag();
	...
	(void)(T13_);
	{
		...
		raiseOSError__CWyPYlyH9a6rAuZckFyVxPA(T18_, TM__HZdw8BhppcTQo8DIK46LSg_12);
		if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
	}
	LA16_: ;
	error = (int)0;
	sizeRead = read((*data).pErrorPipe[(((NI) 0))- 0], ((void*) ((&error))), ((NI) 4));
	{
		...
		T25_[1] = colontmpD_;
		colontmpD__2 = nsuFormatOpenArray(TM__HZdw8BhppcTQo8DIK46LSg_14, T25_, 2);
...
{nimErr_ = nimErrorFlag();
	...
	{
		if (!(env == ((tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg*) NIM_NIL))) goto LA30_;
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA33_;
	{
		...
		T39_[0] = command;
		T39_[1] = TM__HZdw8BhppcTQo8DIK46LSg_16;
		colontmpD__7 = nsuJoinSep(args, argsLen_0, TM__HZdw8BhppcTQo8DIK46LSg_17);
		T39_[2] = colontmpD__7;
		echoBinSafe(T39_, 3);
		{
			LA38_:;
...
{nimErr_ = nimErrorFlag();
	...
	f = (FILE*)0;
	{
		...
		T6_ = (NI32)0;
		T6_ = osLastError__9bUWNxbcGnToMWA9b79aTXLIw();
		raiseOSError__CWyPYlyH9a6rAuZckFyVxPA(T6_, TM__HZdw8BhppcTQo8DIK46LSg_18);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
	LA4_: ;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	colontmp_ = TM__HZdw8BhppcTQo8DIK46LSg_20;
	colontmp__2 = ((NI) -1);
	blitTmp = colontmp_;
	colontmp_.len = 0; colontmp_.p = NIM_NIL;
...
appendString((&result.Field0), TM__HZdw8BhppcTQo8DIK46LSg_22);
			}
			goto LA12_;
			LA15_: ;
			{
