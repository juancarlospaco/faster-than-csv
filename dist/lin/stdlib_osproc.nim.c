...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___l1Qmxnd5LvDYDPdTt9bdc8Q)(tyObject_StartProcessData__xgRnKnLIYRtnOkshMKhc9cA* dest, tyObject_StartProcessData__xgRnKnLIYRtnOkshMKhc9cA* src);
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___l1Qmxnd5LvDYDPdTt9bdc8Q)(tyObject_StartProcessData__xgRnKnLIYRtnOkshMKhc9cA* dest, tyObject_StartProcessData__xgRnKnLIYRtnOkshMKhc9cA* src) {
	eqcopy___aBBXmHFBEivKqERloP6zmA_2((&(*dest).sysCommand), (*src).sysCommand);
...
{nimErr_ = nimErrorFlag();
	...
	pid = (pid_t)0;
	eqcopy___l1Qmxnd5LvDYDPdTt9bdc8Q((&dataCopy), data);
	pid = fork();
	{
...
{nimErr_ = nimErrorFlag();
	...
	LA4_: ;
	{
		...
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
		eqcopy___aBBXmHFBEivKqERloP6zmA_2((&colontmpD_), data.sysCommand);
		sysArgsRaw.p->data[0] = colontmpD_;
		sysArgsRaw.p->data[1] = TM__HZdw8BhppcTQo8DIK46LSg_7;
		colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
		eqcopy___aBBXmHFBEivKqERloP6zmA_2((&colontmpD__2), command);
	...
	LA20_: ;
	{
		...
		eqcopy___aBBXmHFBEivKqERloP6zmA_2((&data.sysCommand), command);
		...
		colontmpD__3.len = 0; colontmpD__3.p = NIM_NIL;
		eqcopy___aBBXmHFBEivKqERloP6zmA_2((&colontmpD__3), command);
		...
		eqsink___r6aagoRVuov7HvfEjIi3Uw((&sysArgsRaw), T23_);
		{
			...
			i = ((NI) 0);
			{
				while (1) {
					...
					arg = (&args[i]);
					colontmpD__4.len = 0; colontmpD__4.p = NIM_NIL;
					eqcopy___aBBXmHFBEivKqERloP6zmA_2((&colontmpD__4), (*arg));
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	eqcopy___uD7PP9aMywYClkkmJVib7sg_2(&result, (*p).outStream);
	goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
...
{nimErr_ = nimErrorFlag();
	...
	LA3_: ;
	eqcopy___uD7PP9aMywYClkkmJVib7sg_2(&result, (*p).inStream);
	goto BeforeRet_;
	}BeforeRet_: ;
	return result;
}
