...
static NIM_CONST tyArray__nHXaesL0DJZHyVS07ARPRA TM__HZdw8BhppcTQo8DIK46LSg_13 = {((NimStringDesc*) NIM_NIL)}
;
	...
	if (TM__HZdw8BhppcTQo8DIK46LSg_8.status == 0) {
		...
		if (TM__HZdw8BhppcTQo8DIK46LSg_10.status == 0) {
			...
			pid = startProcessAuxFork__fxpm29cY48fSnfKctT4HQMg((&data));
			{
				...
				T37_[1] = copyString(((NimStringDesc*) &TM__HZdw8BhppcTQo8DIK46LSg_15));
				T37_[2] = nsuJoinSep(args, argsLen_0, ((NimStringDesc*) &TM__HZdw8BhppcTQo8DIK46LSg_15));
				echoBinSafe(T37_, 3);
			}
			LA35_: ;
			(*result).id = pid;
			...
			{
				if (!((options &(1U<<((NU)(((tyEnum_ProcessOption__bnU6W8LhTMnT4JaSWtGlSA) 4))&7U)))!=0)) goto LA40_;
				(*result).inHandle = ((int) 0);
				(*result).outHandle = ((int) 1);
				{
					if (!((options &(1U<<((NU)(((tyEnum_ProcessOption__bnU6W8LhTMnT4JaSWtGlSA) 3))&7U)))!=0)) goto LA44_;
			...
			LA40_: ;
			{
				...
				{
					int T52_;
					if (!((options &(1U<<((NU)(((tyEnum_ProcessOption__bnU6W8LhTMnT4JaSWtGlSA) 3))&7U)))!=0)) goto LA50_;
					(*result).errHandle = (*result).outHandle;
					T52_ = (int)0;
