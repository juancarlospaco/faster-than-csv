...
/* Command for C compiler:
   gcc -c  -w  -fPIC  -I/home/juan/.choosenim/toolchains/nim-1.2.0/lib -I/home/juan/code/faster-than-csv/src -o /home/juan/code/faster-than-csv/dist/lin/stdlib_osproc.nim.c.o /home/juan/code/faster-than-csv/dist/lin/stdlib_osproc.nim.c */
...
STRING_LITERAL(TM__HZdw8BhppcTQo8DIK46LSg_8, "osproc.nim(858, 14) `args.len == 0` `args` has to be empty when"
...
STRING_LITERAL(TM__HZdw8BhppcTQo8DIK46LSg_36, "osproc.nim(1308, 17) `poParentStreams notin p.options` API usag"
"e error: stream access not allowed when you use poParentStreams", 126);
STRING_LITERAL(TM__HZdw8BhppcTQo8DIK46LSg_37, "osproc.nim(1302, 17) `poParentStreams notin p.options` API usag"
"e error: stream access not allowed when you use poParentStreams", 126);
...
N_LIB_PRIVATE N_NIMCALL(NCSTRING*, envToCStringArray__f7KyzfnKBI6fit7etE9c9aSA)(void) {
	...
	T6_ = (void*)0;
	T6_ = alloc0Impl__WrVG9abV9chlTLqkiXYLKwUg_2(((NI) ((NI)(TM__HZdw8BhppcTQo8DIK46LSg_16))));
	result = ((NCSTRING*) (T6_));
	nimln_(806, "osproc.nim");
	i_2 = ((NI) 0);
	{
		NimStringDesc* key_2;
		NimStringDesc* val_2;
...
appendString(T12_, val_2);
					...
					T13_ = (void*)0;
					T13_ = allocImpl__WrVG9abV9chlTLqkiXYLKwUg(((NI) ((NI)(TM__HZdw8BhppcTQo8DIK46LSg_20))));
					...
					copyMem__i80o3k0SgEI5gTRCzYdyWAsystem(((void*) (result[i_2])), ((void*) ((&x->data[((NI) 0)]))), ((NI) ((NI)(TM__HZdw8BhppcTQo8DIK46LSg_21))));
					nimln_(811, "osproc.nim");
...
N_LIB_PRIVATE N_NIMCALL(NCSTRING*, envToCStringArray__ycBq0pnoixEzCDQfJtZIrQ)(tyObject_StringTableObj__V5PVrt9bIxZEeV7lfvqqtNg* t) {
	...
	T2_ = (void*)0;
	T2_ = alloc0Impl__WrVG9abV9chlTLqkiXYLKwUg_2(((NI) ((NI)(TM__HZdw8BhppcTQo8DIK46LSg_25))));
	result = ((NCSTRING*) (T2_));
...
appendString(T12_, val);
						...
						T13_ = (void*)0;
						T13_ = allocImpl__WrVG9abV9chlTLqkiXYLKwUg(((NI) ((NI)(TM__HZdw8BhppcTQo8DIK46LSg_26))));
						result[i] = ((NCSTRING) (T13_));
						nimln_(799, "osproc.nim");
						if ((NU)(((NI) 0)) >= (NU)(x ? x->Sup.len : 0)){ raiseIndexError2(((NI) 0),(x ? x->Sup.len : 0)-1); }
						...
						copyMem__i80o3k0SgEI5gTRCzYdyWAsystem(((void*) (result[i])), ((void*) ((&x->data[((NI) 0)]))), ((NI) ((NI)(TM__HZdw8BhppcTQo8DIK46LSg_27))));
...
{	_nimCurFrame = getFrame();
	...
	if (TM__HZdw8BhppcTQo8DIK46LSg_31.status == 0) {
		...
		nimln_(1000, "osproc.nim");
		{
			...
			T25_ = nsuFormatOpenArray(((NimStringDesc*) &TM__HZdw8BhppcTQo8DIK46LSg_34), T23_, 2);
			nimln_(1001, "osproc.nim");
			raiseOSError__CWyPYlyH9a6rAuZckFyVxPA(T22_, T25_);
		}
		LA20_: ;
		nimln_(1005, "osproc.nim");
		result = pid;
		popSafePoint();
		nimln_(974, "osproc.nim");
		T26_ = (int)0;
	...
	if (TM__HZdw8BhppcTQo8DIK46LSg_10.status == 0) {
		...
		if (TM__HZdw8BhppcTQo8DIK46LSg_30.status == 0) {
			...
			nimln_(894, "osproc.nim");
			{
				...
				T41_[1] = copyString(((NimStringDesc*) &TM__HZdw8BhppcTQo8DIK46LSg_35));
				T41_[2] = nsuJoinSep(args, argsLen_0, ((NimStringDesc*) &TM__HZdw8BhppcTQo8DIK46LSg_35));
				echoBinSafe(T41_, 3);
			}
			LA39_: ;
			nimln_(896, "osproc.nim");
			(*result).id = pid;
			nimln_(897, "osproc.nim");
			(*result).exitFlag = NIM_FALSE;
			nimln_(899, "osproc.nim");
			{
				if (!((options &(1U<<((NU)(((tyEnum_ProcessOption__bnU6W8LhTMnT4JaSWtGlSA) 4))&7U)))!=0)) goto LA44_;
				nimln_(901, "osproc.nim");
				(*result).inHandle = ((int) 0);
				nimln_(902, "osproc.nim");
				(*result).outHandle = ((int) 1);
				nimln_(903, "osproc.nim");
				{
					if (!((options &(1U<<((NU)(((tyEnum_ProcessOption__bnU6W8LhTMnT4JaSWtGlSA) 3))&7U)))!=0)) goto LA48_;
			...
			LA44_: ;
			{
				...
				{
					int T56_;
					if (!((options &(1U<<((NU)(((tyEnum_ProcessOption__bnU6W8LhTMnT4JaSWtGlSA) 3))&7U)))!=0)) goto LA54_;
					nimln_(911, "osproc.nim");
					(*result).errHandle = (*result).outHandle;
...
{	result = (NI)0;
	...
	nimln_(1289, "osproc.nim");
	{
		...
		nimln_(1290, "osproc.nim");
		{
			...
			if (!T12_) goto LA13_;
			nimln_(1291, "osproc.nim");
			(*p).exitFlag = NIM_TRUE;
			nimln_(1292, "osproc.nim");
			(*p).exitStatus = status;
			nimln_(1293, "osproc.nim");
			T15_ = (int)0;
...
N_LIB_PRIVATE N_NIMCALL(void, nospclose)(tyObject_ProcessObj__2rGNQnv9bU4hanI2g3svReg* p) {
	...
	nimln_(1060, "osproc.nim");
	{
		if (!!((((*p).options &(1U<<((NU)(((tyEnum_ProcessOption__bnU6W8LhTMnT4JaSWtGlSA) 4))&7U)))!=0))) goto LA3_;
		nimln_(1061, "osproc.nim");
		{
			if (!!(((*p).inStream == NIM_NIL))) goto LA7_;
			nimln_(1062, "osproc.nim");
		...
		{
			int T10_;
			nimln_(1064, "osproc.nim");
			T10_ = (int)0;
			T10_ = close((*p).inHandle);
			(void)(T10_);
		}
		LA5_: ;
		nimln_(1066, "osproc.nim");
		{
			if (!!(((*p).outStream == NIM_NIL))) goto LA13_;
			nimln_(1067, "osproc.nim");
		...
		{
			int T16_;
			nimln_(1069, "osproc.nim");
			T16_ = (int)0;
			T16_ = close((*p).outHandle);
			(void)(T16_);
		}
		LA11_: ;
		nimln_(1071, "osproc.nim");
		{
			if (!!(((*p).errStream == NIM_NIL))) goto LA19_;
			nimln_(1072, "osproc.nim");
