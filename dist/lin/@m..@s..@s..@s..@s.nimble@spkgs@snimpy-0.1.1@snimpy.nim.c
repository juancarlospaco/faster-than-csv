...
N_LIB_PRIVATE N_CDECL(void, freeNimObj__jz2epPJWRa0T6WbzV9cD4Og)(void* p) {
	Exception* T1_;
{	T1_ = (Exception*)0;
	T1_ = (Exception*) nimNewObj(sizeof(Exception), NIM_ALIGNOF(Exception));
	(*T1_).Sup.m_type = (&NTIv2__XEycrCsme5C8CVWAYEcdBQ_);
	(*T1_).name = "Exception";
	(*T1_).message = TM__LoH0foxqckmmftA2y2Dp9aw_3;
	(*T1_).parent = ((Exception*) NIM_NIL);
...
{	result.len = 0; result.p = NIM_NIL;
	...
	{
		if (!(currException__9bVPeDJlYTi9bQApZpfH8wjg == ((Exception*) NIM_NIL))) goto LA4_;
		result = TM__LoH0foxqckmmftA2y2Dp9aw_10;
	}
	goto LA2_;
	LA4_: ;
	{
		eqcopy___aBBXmHFBEivKqERloP6zmA_2((&result), (*currException__9bVPeDJlYTi9bQApZpfH8wjg).message);
	}
	LA2_: ;
	goto BeforeRet_;
	}BeforeRet_: ;
