...
STRING_LITERAL(TM__Q5wkpxktOdTGvlSRo9bzt9aw_36, "0", 1);
N_LIB_PRIVATE TNimType NTI__nmiMWKVIe46vacnhAFrQvw_;
STRING_LITERAL(TM__Q5wkpxktOdTGvlSRo9bzt9aw_37, " (invalid data!)", 16);
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, dollar___RkX9btpg5sQIaP8yYXB6tbA)(NU64 x) {
	...
	{
		if (!(x == 0ULL)) goto LA3_;
		result = copyString(((NimStringDesc*) &TM__Q5wkpxktOdTGvlSRo9bzt9aw_36));
	}
	goto LA1_;
	LA3_: ;
	{
...
appendString(T19_, ((NimStringDesc*) &TM__Q5wkpxktOdTGvlSRo9bzt9aw_37));
	result = T19_;
	}BeforeRet_: ;
	return result;
}
...
NTI__x1muge9crz9aAVqWWUrEL9aXg_.node = &TM__Q5wkpxktOdTGvlSRo9bzt9aw_0[13];
...
NTI__LbeSGvgPzGzXnW9caIkJqMA_.node = &TM__Q5wkpxktOdTGvlSRo9bzt9aw_0[14];
