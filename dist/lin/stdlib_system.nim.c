...
N_LIB_PRIVATE N_NIMCALL(void*, alignedAlloc0__tDURxGxuLs0hKEDbtrBxug)(NI size, NI align);
...
N_LIB_PRIVATE N_NIMCALL(void*, alignedRealloc0__RCSc9brnnLyF1fOxNrJWWwA)(void* p, NI oldSize, NI newSize, NI align);
N_LIB_PRIVATE N_NOCONV(void*, realloc0Impl__CRabJkeE1THyovTYlxjdVw)(void* p, NI oldSize, NI newSize);
N_LIB_PRIVATE N_NIMCALL(void*, alignedAlloc__tDURxGxuLs0hKEDbtrBxug_2)(NI size, NI align);
...
N_LIB_PRIVATE N_NIMCALL(void*, alignedAlloc0__tDURxGxuLs0hKEDbtrBxug)(NI size, NI align) {
	...
	result = (void*)0;
	{
		...
		result = alloc0Impl__KzdpcuLT9aef9bsiSHlIu9aFg_2(size);
	}
	goto LA1_;
	LA3_: ;
	{
		...
		NI T6_;
		NI T7_;
		base = alloc0Impl__KzdpcuLT9aef9bsiSHlIu9aFg_2(((NI) ((NI)((NI)((NI)(((NI) (size)) + ((NI) (align))) - ((NI) 1)) + ((NI) 2)))));
		offset = (NI)(((NI) (align)) - (NI)(((NI) (ptrdiff_t) (base)) & (NI)(((NI) (align)) - ((NI) 1))));
		T6_ = (NI)0;
		T6_ = pluspercent___dgYAo7RfdUVVpvkfKDym8wsystem(((NI) (ptrdiff_t) (base)), (NI)(offset - ((NI) 2)));
...
N_LIB_PRIVATE N_NIMCALL(void*, newSeqPayload)(NI cap, NI elemSize, NI elemAlign) {
	...
	result = (void*)0;
	{
		...
		T6_ = (void*)0;
		T6_ = alignedAlloc0__tDURxGxuLs0hKEDbtrBxug(((NI) ((NI)(T5_ + (NI)(cap * elemSize)))), ((NI) (elemAlign)));
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, mnewString)(NI len) {
	...
	LA3_: ;
	{
		...
		colontmpD_ = (NI)0;
		T6_ = (void*)0;
		T6_ = alloc0Impl__KzdpcuLT9aef9bsiSHlIu9aFg_2(((NI) ((NI)((NI)(len + ((NI) 1)) + ((NI) 8)))));
		p = ((NimStrPayload*) (T6_));
		(*p).cap = len;
		nimZeroMem((void*)(&result), sizeof(NimStringV2));
		colontmpD_ = len;
...
N_LIB_PRIVATE N_NIMCALL(void, nimPrepareStrMutationImpl__C0YoABEefTaYbWLv9aVOzZA)(NimStringV2* s) {
	...
	oldP = (*s).p;
	T1_ = (void*)0;
	T1_ = alloc0Impl__KzdpcuLT9aef9bsiSHlIu9aFg_2(((NI) ((NI)((NI)((*s).len + ((NI) 1)) + ((NI) 8)))));
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, rawNewString)(NI space) {
	...
	LA3_: ;
	{
		...
		void* T6_;
		T6_ = (void*)0;
		T6_ = alloc0Impl__KzdpcuLT9aef9bsiSHlIu9aFg_2(((NI) ((NI)((NI)(space + ((NI) 1)) + ((NI) 8)))));
		p = ((NimStrPayload*) (T6_));
		(*p).cap = space;
		nimZeroMem((void*)(&result), sizeof(NimStringV2));
		result.len = ((NI) 0);
...
N_LIB_PRIVATE N_NIMCALL(void*, alignedAlloc__tDURxGxuLs0hKEDbtrBxug_2)(NI size, NI align) {
	...
	LA3_: ;
	{
		...
		NI T6_;
		NI T7_;
		base = allocImpl__KzdpcuLT9aef9bsiSHlIu9aFg(((NI) ((NI)((NI)((NI)(((NI) (size)) + ((NI) (align))) - ((NI) 1)) + ((NI) 2)))));
		offset = (NI)(((NI) (align)) - (NI)(((NI) (ptrdiff_t) (base)) & (NI)(((NI) (align)) - ((NI) 1))));
		T6_ = (NI)0;
		T6_ = pluspercent___dgYAo7RfdUVVpvkfKDym8wsystem(((NI) (ptrdiff_t) (base)), (NI)(offset - ((NI) 2)));
		(*((NU16*) (((void*) (T6_))))) = ((NU16) (offset));
...
N_LIB_PRIVATE N_NIMCALL(void*, alignedRealloc0__RCSc9brnnLyF1fOxNrJWWwA)(void* p, NI oldSize, NI newSize, NI align) {
	...
	LA3_: ;
	{
		...
		T7_ = (void*)0;
		T7_ = ((void*) (T6_));
		zeroMem__FsvhfMqbswETmyMWtamDewsystem(T7_, ((NI) ((NI)(((NI) (newSize)) - ((NI) (oldSize))))));
...
N_LIB_PRIVATE N_NIMCALL(void*, prepareSeqAdd)(NI len, void* p, NI addlen, NI elemSize, NI elemAlign) {
	...
	LA6_: ;
	{
		...
		newCap = ((T9_ >= (NI)(len + addlen)) ? T9_ : (NI)(len + addlen));
		{
			...
			T14_ = (void*)0;
			T14_ = alignedAlloc0__tDURxGxuLs0hKEDbtrBxug(((NI) ((NI)(headerSize + (NI)(elemSize * newCap)))), ((NI) (elemAlign)));
		...
		LA12_: ;
		{
			...
			T19_ = (void*)0;
			T19_ = alignedRealloc0__RCSc9brnnLyF1fOxNrJWWwA(((void*) (p_2)), ((NI) (oldSize)), ((NI) (newSize)), ((NI) (elemAlign)));
...
N_LIB_PRIVATE N_NIMCALL(void*, nimNewObj)(NI size, NI alignment) {
	...
	s = (NI)(size + hdrSize);
	T1_ = (void*)0;
	T1_ = alignedAlloc0__tDURxGxuLs0hKEDbtrBxug(((NI) (s)), ((NI) (alignment)));
	T2_ = (NI)0;
...
N_LIB_PRIVATE N_NIMCALL(void, prepareAdd)(NimStringV2* s, NI addlen) {
	{
		...
		oldP = (*s).p;
		T7_ = (void*)0;
		T7_ = alloc0Impl__KzdpcuLT9aef9bsiSHlIu9aFg_2(((NI) ((NI)((NI)((NI)((*s).len + addlen) + ((NI) 1)) + ((NI) 8)))));
	...
	LA5_: ;
	{
		...
		oldCap = (NI)((*(*s).p).cap & ((NI) IL64(-4611686018427387905)));
		{
			...
			T20_ = (void*)0;
			T20_ = realloc0Impl__CRabJkeE1THyovTYlxjdVw(((void*) ((*s).p)), T19_, ((NI) ((NI)((NI)(newCap + ((NI) 1)) + ((NI) 8)))));
...
N_LIB_PRIVATE N_NIMCALL(void, add__2EDGtEFHI3Ys0d2ff6xvLQ)(tySequence__E2XyP5e7Jr9aMpJMjdz5Tkg* x, tyObject_PyMethodDef__9aWi1PsmvCuTKIYDHHnhfcw* value) {
	...
	xu = ((tyObject_NimSeqV2__332JYc78aOGWXtSPbXruiw*) (x));
	{
		...
		void* T8_;
		T4_ = (NIM_BOOL)0;
		T4_ = ((*xu).p == ((tyObject_NimSeqPayload__UFW0P8yVykK5QUaUesygGw*) NIM_NIL));
		if (T4_) goto LA5_;
		T4_ = ((*(*xu).p).cap < (NI)(oldLen + ((NI) 1)));
		LA5_: ;
		if (!T4_) goto LA6_;
...
{	{
	...
	LA9_: ;
	{
		...
		void* T34_;
		{
			...
			LA30_: ;
			T32_ = (void*)0;
			T32_ = alloc0Impl__KzdpcuLT9aef9bsiSHlIu9aFg_2(((NI) ((NI)((NI)(b.len + ((NI) 1)) + ((NI) 8)))));
...
N_LIB_PRIVATE N_NIMCALL(void, add__tXoS41N8tpGl9a5fRivX89bA)(tySequence__M73GJ9bOx1XdoIRnhIyhqTQ* x, tyObject_ExportedModule__fxDBwb9c9c8NsdRe9bmg8Q9a2A* value) {
	...
	xu = ((tyObject_NimSeqV2__2jX5lyY59bqg1HTkK1R8Jgg*) (x));
	{
		...
		void* T8_;
		T4_ = (NIM_BOOL)0;
		T4_ = ((*xu).p == ((tyObject_NimSeqPayload__GtsWF9alFxmh9aJu01kASRtA*) NIM_NIL));
		if (T4_) goto LA5_;
		T4_ = ((*(*xu).p).cap < (NI)(oldLen + ((NI) 1)));
		LA5_: ;
		if (!T4_) goto LA6_;
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___r6aagoRVuov7HvfEjIi3Uw_2)(tySequence__sM4lkSb7zS6F7OVMvW9cffQ* dest, tySequence__sM4lkSb7zS6F7OVMvW9cffQ src) {
	...
	colontmp_ = ((NI) 0);
	{
		while (1) {
			...
			eqcopy___aBBXmHFBEivKqERloP6zmA_2((&(*dest).p->data[colontmp_]), src.p->data[colontmp_]);
			colontmp_ += ((NI) 1);
		} LA3: ;
	}
}
...
N_LIB_PRIVATE N_NIMCALL(void, add__NhALwp9aEDwhMGSPr0KFylQ)(tySequence__rgubAid5B4Ixbg70snLJsg* x, tyObject_Table__Ji6x6JQ0gVMaFr8AIk18Ug value) {
	...
	xu = ((tyObject_NimSeqV2__xMydwB2R6TFc2n4Y19cF5Ow*) (x));
	{
		...
		void* T8_;
		T4_ = (NIM_BOOL)0;
		T4_ = ((*xu).p == ((tyObject_NimSeqPayload__uIvrHxdSavYdtkQOkH9anSA*) NIM_NIL));
		if (T4_) goto LA5_;
		T4_ = ((*(*xu).p).cap < (NI)(oldLen + ((NI) 1)));
		LA5_: ;
		if (!T4_) goto LA6_;
	...
	x = ((NimStringV2*) (a));
	{
		...
		res = ((NI) 0);
		{
			while (1) {
				...
				i = res;
				T5_ = (void*)0;
				T5_ = alloc0Impl__KzdpcuLT9aef9bsiSHlIu9aFg_2(((NI) ((NI)(x[i].len + ((NI) 1)))));
...
{	{
	...
	LA4_: ;
	{
		...
		xu = ((tyObject_NimSeqV2__hv2iQpjL2YeWzYVIQf8ghA*) (s));
		{
			...
			void* T19_;
			T14_ = (NIM_BOOL)0;
			T14_ = ((*xu).p == ((tyObject_NimSeqPayload__OkHvTCg4qz3eYz2kkTP8ag*) NIM_NIL));
			if (T14_) goto LA15_;
			T14_ = ((*(*xu).p).cap < ((NI) (newlen)));
			LA15_: ;
			if (!T14_) goto LA16_;
...
{	{
	...
	LA4_: ;
	{
		...
		xu = ((tyObject_NimSeqV2__FjIKVaKnH9cNk67XWjQhtLQ*) (s));
		{
			...
			void* T19_;
			T14_ = (NIM_BOOL)0;
			T14_ = ((*xu).p == ((tyObject_NimSeqPayload__NNfzog8uS2dUdDMRTegzWg*) NIM_NIL));
			if (T14_) goto LA15_;
			T14_ = ((*(*xu).p).cap < ((NI) (newlen)));
			LA15_: ;
			if (!T14_) goto LA16_;
...
N_LIB_PRIVATE N_NIMCALL(void*, nimNewObjUninit)(NI size, NI alignment) {
	...
	s = (NI)(size + hdrSize);
	T1_ = (void*)0;
	T1_ = alignedAlloc__tDURxGxuLs0hKEDbtrBxug_2(((NI) (s)), ((NI) (alignment)));
	T2_ = (NI)0;
	T2_ = pluspercent___dgYAo7RfdUVVpvkfKDym8wsystem(((NI) (ptrdiff_t) (T1_)), hdrSize);
	result = ((void*) (((tyObject_RefHeader__Gi7WQzlT1ZRToh9a2ueYb4A*) (((void*) (T2_))))));
	T3_ = (NI)0;
	T3_ = minuspercent___dgYAo7RfdUVVpvkfKDym8w_2system(((NI) (ptrdiff_t) (result)), ((NI) 8));
...
{nimErr_ = nimErrorFlag();
	...
	r = (tyObject_SslContextExtraInternalcolonObjectType___22zILeNTc8ClX7DrPZ3XOQ*) nimNewObj(sizeof(tyObject_SslContextExtraInternalcolonObjectType___22zILeNTc8ClX7DrPZ3XOQ), NIM_ALIGNOF(tyObject_SslContextExtraInternalcolonObjectType___22zILeNTc8ClX7DrPZ3XOQ));
...
N_LIB_PRIVATE N_NIMCALL(tySequence__sM4lkSb7zS6F7OVMvW9cffQ, X5BX5D___dxs1m8X8HLcMK21WAkRfcw)(NimStringV2* s, NI sLen_0, tyObject_HSlice__EE5dzjqoOrHT6HJhIPXAvA x) {
	...
	result.len = ((NI) (L)); result.p = (tySequence__sM4lkSb7zS6F7OVMvW9cffQ_Content*) newSeqPayload(((NI) (L)), sizeof(NimStringV2), NIM_ALIGNOF(NimStringV2));
	{
		NI i;
		NI i_2;
		i = (NI)0;
		i_2 = ((NI) 0);
		{
			while (1) {
				if (!(i_2 < L)) goto LA3;
				i = i_2;
				eqcopy___aBBXmHFBEivKqERloP6zmA_2((&result.p->data[i]), s[(NI)(i + a)]);
				i_2 += ((NI) 1);
			} LA3: ;
		}
	}
...
N_LIB_PRIVATE N_NIMCALL(void, X5BX5Deq___nzw30OOxYaJmEInmJdKSvg)(NimStringV2* s, tyObject_HSlice__EE5dzjqoOrHT6HJhIPXAvA x, NimStringV2 b) {
	...
	LA3_: ;
	{
		NI shiftX60gensym386_;
		NI newLenX60gensym386_;
		shiftX60gensym386_ = (NI)(b.len - ((((NI) 0) >= L) ? ((NI) 0) : L));
		newLenX60gensym386_ = (NI)((*s).len + shiftX60gensym386_);
		{
			if (!(((NI) 0) < shiftX60gensym386_)) goto LA11_;
			setLengthStrV2((&(*s)), ((NI) (newLenX60gensym386_)));
			{
				NI iX60gensym386_;
				NI colontmp_;
				NI colontmp__2;
				...
				colontmp_ = (NI)0;
				colontmp__2 = (NI)0;
				colontmp_ = (NI)(newLenX60gensym386_ - ((NI) 1));
				...
				res = colontmp_;
				{
					while (1) {
						...
						iX60gensym386_ = res;
						nimPrepareStrMutationV2((&(*s)));
						(*s).p->data[iX60gensym386_] = (*s).p->data[(NI)(iX60gensym386_ - shiftX60gensym386_)];
						(*s).p->data[(NI)(iX60gensym386_ - shiftX60gensym386_)] = 0;
						res -= ((NI) 1);
					} LA15: ;
				}
			}
		...
		{
			{
				...
				NI colontmp__4;
				NI res_2;
				iX60gensym386__2 = (NI)0;
				colontmp__3 = (NI)0;
				colontmp__4 = (NI)0;
				colontmp__3 = (NI)(a + b.len);
				colontmp__4 = (NI)(newLenX60gensym386_ - ((NI) 1));
				res_2 = colontmp__3;
				{
					while (1) {
						if (!(res_2 <= colontmp__4)) goto LA19;
						iX60gensym386__2 = res_2;
						nimPrepareStrMutationV2((&(*s)));
						(*s).p->data[iX60gensym386__2] = (*s).p->data[(NI)(iX60gensym386__2 - shiftX60gensym386_)];
						(*s).p->data[(NI)(iX60gensym386__2 - shiftX60gensym386_)] = 0;
						res_2 += ((NI) 1);
					} LA19: ;
				}
			}
		...
		LA9_: ;
		{
			...
			i_3 = ((NI) 0);
			{
				while (1) {
					...
					iX60gensym386__3 = i_3;
					nimPrepareStrMutationV2((&(*s)));
					(*s).p->data[(NI)(a + iX60gensym386__3)] = b.p->data[iX60gensym386__3];
					i_3 += ((NI) 1);
				} LA22: ;
			}
		}
...
N_LIB_PRIVATE N_NIMCALL(void, add__n1noU49a59c3SzQ4PiBl0J6w)(tySequence__AjV3cEUgs0Y9c7dCt9aItdIA* x, tyObject_XmlNodeObj__X79bE2j9a1V7tizbx9blALudQ* value) {
	...
	xu = ((tyObject_NimSeqV2__BQ5dg01HrJfutgTBYdkjPQ*) (x));
	{
		...
		void* T8_;
		T4_ = (NIM_BOOL)0;
		T4_ = ((*xu).p == ((tyObject_NimSeqPayload__aYMDkpL4F1q0itr3BPApUA*) NIM_NIL));
		if (T4_) goto LA5_;
		T4_ = ((*(*xu).p).cap < (NI)(oldLen + ((NI) 1)));
		LA5_: ;
		if (!T4_) goto LA6_;
...
N_LIB_PRIVATE N_NIMCALL(void, add__AYssNOWUJMJCw80v9b5evwA)(tySequence__4CoKBAViiN2VV33Ov2SWmA* x, tyObject_Item__T8diAqAiCs9bhc5T1iInskQ* value) {
	...
	xu = ((tyObject_NimSeqV2__pjD3FjuLcM0XtRehFNwQaw*) (x));
	{
		...
		void* T8_;
		T4_ = (NIM_BOOL)0;
		T4_ = ((*xu).p == ((tyObject_NimSeqPayload__dLgWkX0gTEX9aJOD0DCzBDg*) NIM_NIL));
		if (T4_) goto LA5_;
		T4_ = ((*(*xu).p).cap < (NI)(oldLen + ((NI) 1)));
		LA5_: ;
		if (!T4_) goto LA6_;
