...
{nimErr_ = nimErrorFlag();
	...
	toCopy = (NI)((*L).buf.len - (NI)((*L).sentinel + ((NI) 1)));
	{
		...
		moveMem__i80o3k0SgEI5gTRCzYdyWA_2system(T5_, ((void*) ((&(*L).buf.p->data[(NI)((*L).sentinel + ((NI) 1))]))), ((NI) (toCopy)));
	}
	LA3_: ;
			...
			while (1) {
				{
					while (1) {
						...
						T18_ = (((NI) 0) <= s);
						if (!(T18_)) goto LA19_;
						T18_ = !((((*L).refillChars[(NU)(((NU8)((*L).buf.p->data[s])))>>3] &(1U<<((NU)(((NU8)((*L).buf.p->data[s])))&7U)))!=0));
						LA19_: ;
						if (!T18_) goto LA17;
						s -= ((NI) 1);
					} LA17: ;
				...
				LA22_: ;
				{
					...
					T26_ = dotdot___BokNSDrKN1xmV1nA01G9brAsystem(colontmpD__2, (NI)((*L).buf.len - ((NI) 1)));
