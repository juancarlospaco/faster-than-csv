...
N_LIB_PRIVATE NIM_CONST tyArray__nHXaesL0DJZHyVS07ARPRA ExeExts__ONrgkgAZ9bh6KVTWl4XeOSw = {{0, (NimStrPayload*)&TM__yu6cxgKBBXbNsTkT9cyMd4g_2}}
;
...
N_LIB_PRIVATE N_NIMCALL(void, getEnvVarsC__580467zYn32AEdYj9cD4LLA)(void) {
	{
		...
		i = ((NI) 0);
		{
			while (1) {
				...
				NimStringV2 T9_;
				T8_ = (NIM_BOOL)0;
				T8_ = eqeq___aqip9cmQIuefPKdd25wuEEwsystem(environ[i], ((NCSTRING) NIM_NIL));
				if (!!(T8_)) goto LA7;
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, normExt__5YE1ExrSIVKLWtBPQtnFCw)(NimStringV2 ext) {
	...
	result.len = 0; result.p = NIM_NIL;
	{
		...
		LA4_: ;
		if (!T3_) goto LA5_;
		eqcopy___aBBXmHFBEivKqERloP6zmA_2((&result), ext);
	}
	goto LA1_;
	LA5_: ;
	{
...
appendString((&T5_), colontmpD_);
	...
	LA3_: ;
	{
		eqcopy___aBBXmHFBEivKqERloP6zmA_2((&result), filename);
	}
	LA1_: ;
	return result;
}
...
{	result.len = 0; result.p = NIM_NIL;
	...
	LA3_: ;
	{
		...
		env = getenv(nimToCStringConv(key));
		{
			...
			NimStringV2 colontmpD_;
			T11_ = (NIM_BOOL)0;
			T11_ = eqeq___aqip9cmQIuefPKdd25wuEEwsystem(env, ((NCSTRING) NIM_NIL));
			if (!T11_) goto LA12_;
			colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
			colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
			eqcopy___aBBXmHFBEivKqERloP6zmA_2((&colontmpD_), default_0);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, expandTilde__RmQRR8GLDFICboxWoCEpMw)(NimStringV2 path) {
	...
	result.len = 0; result.p = NIM_NIL;
	{
		...
		LA4_: ;
		if (!T3_) goto LA5_;
		eqcopy___aBBXmHFBEivKqERloP6zmA_2((&result), path);
	}
	goto LA1_;
	LA5_: ;
	{
