...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___hf0dTehZytuPaBioHlpymw)(tySequence__JiteSJxrvz63iP2o9bcn2Sg* dest, tySequence__JiteSJxrvz63iP2o9bcn2Sg src);
...
N_LIB_PRIVATE N_NIMCALL(void, del__lDa9cDK9bq8jxuc4T2AsuSpw)(tyObject_Table__qagh2zcXAhSb9aRfetCb26g* t, NimStringV2 key);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_Table__Ji6x6JQ0gVMaFr8AIk18Ug, initTable__70Pc0gZKXvzWyIAY49a3CBA)(NI initialSize) {
	...
	correctSizeX60gensym23_ = slotsNeeded__LvRw9cAKRC9b1pD3bnSd1DdAtables(((NI) (initialSize)));
	result.counter = ((NI) 0);
	result.data.len = ((NI) (correctSizeX60gensym23_)); result.data.p = (tySequence__SFipDZIkFtPcrLs0AGBBjQ_Content*) newSeqPayload(((NI) (correctSizeX60gensym23_)), sizeof(tyTuple__8ZxhPt1NwfElsJs8zUSV9bg), NIM_ALIGNOF(tyTuple__8ZxhPt1NwfElsJs8zUSV9bg));
	return result;
}
static N_INLINE(NIM_BOOL, isFilled__5Qpmu5QqwDY0esVXn6wf7wtables)(NI hcode) {
	NIM_BOOL result;
...
N_LIB_PRIVATE N_NIMCALL(void, X5BX5Deq___n7H2lOZnf3GlRkWmu9b3zmw)(tyObject_Table__Ji6x6JQ0gVMaFr8AIk18Ug* t, NimStringV2 key, NimStringV2 val) {
	...
	NI index;
	{
		...
		T3_ = (*t).data.len;
		if (!(T3_ == ((NI) 0))) goto LA4_;
		correctSizeX60gensym26_ = slotsNeeded__LvRw9cAKRC9b1pD3bnSd1DdAtables(((NI) 32));
		(*t).counter = ((NI) 0);
		(*t).data.len = ((NI) (correctSizeX60gensym26_)); (*t).data.p = (tySequence__SFipDZIkFtPcrLs0AGBBjQ_Content*) newSeqPayload(((NI) (correctSizeX60gensym26_)), sizeof(tyTuple__8ZxhPt1NwfElsJs8zUSV9bg), NIM_ALIGNOF(tyTuple__8ZxhPt1NwfElsJs8zUSV9bg));
	}
	LA4_: ;
	hc = (NI)0;
	...
	LA8_: ;
	{
		...
		NimStringV2 blitTmp_2;
		{
			...
			correctSizeX60gensym31_ = slotsNeeded__LvRw9cAKRC9b1pD3bnSd1DdAtables(((NI) 32));
			(*t).counter = ((NI) 0);
			(*t).data.len = ((NI) (correctSizeX60gensym31_)); (*t).data.p = (tySequence__SFipDZIkFtPcrLs0AGBBjQ_Content*) newSeqPayload(((NI) (correctSizeX60gensym31_)), sizeof(tyTuple__8ZxhPt1NwfElsJs8zUSV9bg), NIM_ALIGNOF(tyTuple__8ZxhPt1NwfElsJs8zUSV9bg));
		}
		LA14_: ;
		{
			NIM_BOOL T18_;
	...
	result = initTable__70Pc0gZKXvzWyIAY49a3CBA(pairsLen_0);
	{
		...
		i = ((NI) 0);
		{
			while (1) {
				...
				val = (&pairs[i].Field1);
				colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
				eqcopy___aBBXmHFBEivKqERloP6zmA_2((&colontmpD_), (*key));
				T4_.len = 0; T4_.p = NIM_NIL;
				T4_ = colontmpD_;
				colontmpD__2.len = 0; colontmpD__2.p = NIM_NIL;
				eqcopy___aBBXmHFBEivKqERloP6zmA_2((&colontmpD__2), (*val));
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___rVMSIO7FeB1qXZmZBVjm9bA)(tySequence__JiteSJxrvz63iP2o9bcn2Sg* dest) {
	...
	if ((*dest).p && !((*dest).p->cap & NIM_STRLIT_FLAG)) {
 alignedDealloc((*dest).p, NIM_ALIGNOF(tyTuple__g1w83cyyBYiVU9c8WEJWnjQ));
}
}
N_LIB_PRIVATE N_NIMCALL(void, enlarge__9bDxMze9c2f8NEFsPxeJU0pw)(tyObject_Table__qagh2zcXAhSb9aRfetCb26g* t) {
...
N_LIB_PRIVATE N_NIMCALL(tyObject_Table__qagh2zcXAhSb9aRfetCb26g*, newTable__j9aovL9c5jjTLwk0JUYr9b7Tg)(NI initialSize) {
	...
	result = (tyObject_Table__qagh2zcXAhSb9aRfetCb26g*) nimNewObj(sizeof(tyObject_Table__qagh2zcXAhSb9aRfetCb26g), NIM_ALIGNOF(tyObject_Table__qagh2zcXAhSb9aRfetCb26g));
...
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___hf0dTehZytuPaBioHlpymw)(tySequence__JiteSJxrvz63iP2o9bcn2Sg* dest, tySequence__JiteSJxrvz63iP2o9bcn2Sg src) {
	...
	colontmp_ = ((NI) 0);
	{
		while (1) {
			...
			eqcopy___aBBXmHFBEivKqERloP6zmA_2((&(*dest).p->data[colontmp_].Field1), src.p->data[colontmp_].Field1);
			eqcopy___r6aagoRVuov7HvfEjIi3Uw_2((&(*dest).p->data[colontmp_].Field2), src.p->data[colontmp_].Field2);
			colontmp_ += ((NI) 1);
		} LA3: ;
	}
}
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___ic9a3GZ2Kbgw2QwLw0A1dMQ_2)(tyObject_Table__qagh2zcXAhSb9aRfetCb26g* dest, tyObject_Table__qagh2zcXAhSb9aRfetCb26g src) {
	eqcopy___hf0dTehZytuPaBioHlpymw((&(*dest).data), src.data);
	(*dest).counter = src.counter;
}
static N_INLINE(NIM_BOOL, isEmpty__5Qpmu5QqwDY0esVXn6wf7w_2tables)(NI hcode) {
	NIM_BOOL result;
...
N_LIB_PRIVATE N_NIMCALL(void, del__lDa9cDK9bq8jxuc4T2AsuSpw)(tyObject_Table__qagh2zcXAhSb9aRfetCb26g* t, NimStringV2 key) {
	...
	NI T1_;
	hc = (NI)0;
	i = rawGet__a59cxMy3qya79c49c6saGCAYQtables((*t), key, (&hc));
	T1_ = ((*t).data.len-1);
	mskX60gensym36_ = T1_;
	{
		if (!(((NI) 0) <= i)) goto LA4_;
		...
		{
			{
				while (1) {
					...
					tyTuple__g1w83cyyBYiVU9c8WEJWnjQ T32_;
					jX60gensym36_ = i;
					rX60gensym36_ = jX60gensym36_;
					(*t).data.p->data[i].Field0 = ((NI) 0);
					T9_.len = 0; T9_.p = NIM_NIL;
					eqsink___aBBXmHFBEivKqERloP6zmA((&(*t).data.p->data[i].Field1), T9_);
					T10_.len = 0; T10_.p = NIM_NIL;
					eqsink___r6aagoRVuov7HvfEjIi3Uw((&(*t).data.p->data[i].Field2), T10_);
					{
						while (1) {
							i = (NI)((NI)(i + ((NI) 1)) & mskX60gensym36_);
							{
								NIM_BOOL T15_;
								T15_ = (NIM_BOOL)0;
								T15_ = isEmpty__5Qpmu5QqwDY0esVXn6wf7w_2tables((*t).data.p->data[i].Field0);
								if (!T15_) goto LA16_;
								goto LA6;
							}
							LA16_: ;
							rX60gensym36_ = (NI)((*t).data.p->data[i].Field0 & mskX60gensym36_);
							{
								...
								T21_ = (NIM_BOOL)0;
								T22_ = (NIM_BOOL)0;
								T22_ = (rX60gensym36_ <= i);
								if (!(T22_)) goto LA23_;
								T22_ = (jX60gensym36_ < rX60gensym36_);
								LA23_: ;
								T21_ = T22_;
								if (T21_) goto LA24_;
								T25_ = (NIM_BOOL)0;
								T25_ = (jX60gensym36_ < rX60gensym36_);
								if (!(T25_)) goto LA26_;
								T25_ = (i < jX60gensym36_);
								LA26_: ;
								T21_ = T25_;
								LA24_: ;
								T20_ = T21_;
								if (T20_) goto LA27_;
								T28_ = (NIM_BOOL)0;
								T28_ = (i < jX60gensym36_);
								if (!(T28_)) goto LA29_;
								T28_ = (rX60gensym36_ <= i);
								LA29_: ;
								T20_ = T28_;
								LA27_: ;
								if (!!(T20_)) goto LA30_;
					...
					T32_ = (*t).data.p->data[i];
					nimZeroMem((void*)(&(*t).data.p->data[i]), sizeof(tyTuple__g1w83cyyBYiVU9c8WEJWnjQ));
					eqsink___BX2JqNf2E8tN5tqtm9b9aGeg((&(*t).data.p->data[jX60gensym36_]), (&T32_));
				}
			}
		} LA6: ;
	}
...
N_LIB_PRIVATE N_NIMCALL(void, del__kuoXANiRixWCLT0f7qTDSA)(tyObject_Table__qagh2zcXAhSb9aRfetCb26g* t, NimStringV2 key) {
	del__lDa9cDK9bq8jxuc4T2AsuSpw(t, key);
}
