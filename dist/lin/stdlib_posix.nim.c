...
/* Command for C compiler:
   gcc -c  -w  -fPIC  -I/home/juan/.choosenim/toolchains/nim-1.2.0/lib -I/home/juan/code/faster-than-csv/src -o /home/juan/code/faster-than-csv/dist/lin/stdlib_posix.nim.c.o /home/juan/code/faster-than-csv/dist/lin/stdlib_posix.nim.c */
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, WIFSIGNALED__o9b5GK70QLj9ahJeczQ2LyRg)(int s) {
	...
	result = (NIM_BOOL)0;
	nimln_(583, "posix_linux_amd64.nim");
...
N_LIB_PRIVATE N_NIMCALL(int, WTERMSIG__T7ZeAv6ofGPBA29bsuGG1ug)(int s) {
	...
	result = (int)0;
	nimln_(580, "posix_linux_amd64.nim");
...
N_LIB_PRIVATE N_NIMCALL(int, WEXITSTATUS__T7ZeAv6ofGPBA29bsuGG1ug_2)(int s) {
	...
	result = (int)0;
	nimln_(579, "posix_linux_amd64.nim");
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, WIFEXITED__o9b5GK70QLj9ahJeczQ2LyRg_2)(int s) {
	...
	result = (NIM_BOOL)0;
	nimln_(582, "posix_linux_amd64.nim");
	T1_ = (int)0;
