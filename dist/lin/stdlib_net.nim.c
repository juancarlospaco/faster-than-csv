...
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_20, "Couldn\'t resolve address: ", 26);
extern TNimType NTI__Ie1m0dv1ZHg72IgPRr1cDw_;
extern TNimType NTI__yoNlBGx0D2tRizIdhQuENw_;
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_22, "IP Address string is empty", 26);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_23, "Invalid IP Address", 18);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_24, "Invalid IP Address. Address contains an invalid separator", 57);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_25, "Invalid IP Address. Address contains more than one \"::\" separat"
"or", 65);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_26, "Invalid IP Address. The address consists of too many groups", 59);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_27, "Invalid IP Address. Address may not start with \":\"", 50);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_28, "Invalid IP Address. Address may not end with \":\"", 48);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_29, "Invalid IP Address. Value is out of range", 41);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_30, "Invalid IP Address. Address contains an invalid character", 57);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_31, "Invalid IP Address. The address consists of too few groups", 58);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_32, "Could not send all data.", 24);
N_LIB_PRIVATE TNimType NTI__YJ9a3zV3oEciJsNBlUEYRfw_;
N_LIB_PRIVATE TNimType NTI__DtrJpMCrh4f9cUcHkEf48kQ_;
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_33, "Call to \'", 9);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_34, "\' timed out.", 12);
extern TNimType NTI__9apztJSmgERYU8fZOjI4pOg_;
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_35, "readLine", 8);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_36, "\015\012", 2);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_37, "recv", 4);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_38, "SSLv2 is no longer secure and has been deprecated, use protSSLv"
"23", 65);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_39, "SSLv3 is no longer secure and has been deprecated, use protSSLv"
"23", 65);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_40, "Certificate file could not be found: ", 37);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_41, "Key file could not be found: ", 29);
STRING_LITERAL(TM__XqsrSBxhOTPgLQ9cX4MmV4A_42, "Verification of private key file failed.", 40);
...
appendString(T68_, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_20));
...
N_LIB_PRIVATE N_NIMCALL(void, wrapSocket__nSrKttw9bOstnCyvh66mpmQ)(tyObject_SslContextcolonObjectType___nNdejAl9bbVbX7sP6RJ4h0w* ctx, tyObject_SocketImpl__aIhANOOoETolVz9cccNO9cRQ* socket) {
	...
	LA3_: ;
	{
		int T7_;
		T7_ = (int)0;
		T7_ = Dl_17245492_((*socket).sslHandle, (*socket).fd);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_IpAddress__t0yd6ha54oWXm7nwZ4QqfA, parseIPv6Address__1ivqWNphfe1wCfgNmXXOCA_2)(NimStringDesc* addressStr) {
			...
			while (1) {
				...
				c = addressStr->data[i_2];
				{
					if (!((NU8)(c) == (NU8)(58))) goto LA11_;
					{
						...
						(*T17_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_24));
					...
					LA15_: ;
					{
						if (!lastWasColon) goto LA20_;
						{
							...
							(*T26_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_25));
					...
					LA20_: ;
					{
						...
						if (!T28_) goto LA30_;
						{
							...
							(*T36_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_26));
					...
					LA30_: ;
					{
						if (!(i == ((NI) 0))) goto LA42_;
						{
							...
							(*T48_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_27));
					...
					{
						{
							...
							(*T54_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_28));
				...
				LA11_: ;
				{
					if (!((NU8)(c) == (NU8)(46))) goto LA56_;
					{
						...
						(*T66_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_23));
				...
				LA56_: ;
				{
					...
					LA70_: ;
					{
						...
						(*T84_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_29));
				...
				LA68_: ;
				{
					...
					(*T86_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_30));
	...
	} LA6: ;
	{
		if (!(v4StartPos == ((NI) -1))) goto LA89_;
		{
			if (!separatorValid) goto LA93_;
			{
				...
				(*T99_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_26));
	...
	LA89_: ;
	{
				...
				while (1) {
					...
					c_2 = colontmp_->data[i_4];
					{
						...
						currentShort = (NU32)((NU32)((NU32)((NU32)(currentShort) * (NU32)(((NU32) 10)))) + (NU32)(((NU32) ((NI)(((NU8)(c_2)) - ((NI) 48))))));
						{
							...
							(*T113_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_29));
					...
					LA107_: ;
					{
						if (!((NU8)(c_2) == (NU8)(46))) goto LA115_;
						{
							...
							(*T123_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_23));
					...
					LA115_: ;
					{
						...
						(*T125_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_30));
		...
		}
		{
			...
			(*T132_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_23));
	...
	LA87_: ;
	{
		...
		(*T137_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_26));
	...
	LA135_: ;
	{
		...
		if (!(groupCount < ((NI) 8))) goto LA139_;
		{
			...
			(*T145_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_31));
	...
	LA139_: ;
	{
		...
		(*T155_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_26));
...
N_LIB_PRIVATE N_NIMCALL(tyObject_IpAddress__t0yd6ha54oWXm7nwZ4QqfA, parseIPv4Address__1ivqWNphfe1wCfgNmXXOCA_3)(NimStringDesc* addressStr) {
			...
			while (1) {
				...
				i = res;
				{
					...
					currentByte = (NU16)((NU16)((NU16)((NU16)(currentByte) * (NU16)(((NU16) 10)))) + (NU16)(((NU16) ((NI)(((NU8)(addressStr->data[i])) - ((NI) 48))))));
					{
						...
						(*T12_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_29));
				...
				LA6_: ;
				{
					if (!((NU8)(addressStr->data[i]) == (NU8)(46))) goto LA14_;
					{
						...
						(*T22_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_26));
				...
				LA14_: ;
				{
					...
					(*T24_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_30));
	...
	}
	{
		...
		(*T31_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_23));
...
{	nimZeroMem((void*)(&result), sizeof(tyObject_IpAddress__t0yd6ha54oWXm7nwZ4QqfA));
	{
		...
		(*T5_).Sup.Sup.Sup.m_type = (&NTI__yoNlBGx0D2tRizIdhQuENw_);
		(*T5_).Sup.Sup.name = "ValueError";
		(*T5_).Sup.Sup.message = copyString(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_22));
		(*T5_).Sup.Sup.parent = NIM_NIL;
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, isIpAddress__lty7O9aUHIZT9cqYHeC2n5zA)(NimStringDesc* addressStr) {
	NIM_BOOL result;
	TSafePoint TM__XqsrSBxhOTPgLQ9cX4MmV4A_21;
{	result = (NIM_BOOL)0;
	pushSafePoint(&TM__XqsrSBxhOTPgLQ9cX4MmV4A_21);
	TM__XqsrSBxhOTPgLQ9cX4MmV4A_21.status = setjmp(TM__XqsrSBxhOTPgLQ9cX4MmV4A_21.context);
	if (TM__XqsrSBxhOTPgLQ9cX4MmV4A_21.status == 0) {
		...
		if (isObj(nimBorrowCurrentException()->Sup.m_type, (&NTI__yoNlBGx0D2tRizIdhQuENw_))) {
			TM__XqsrSBxhOTPgLQ9cX4MmV4A_21.status = 0;
			result = NIM_FALSE;
			popCurrentException();
			goto BeforeRet_;
			popCurrentException();
	...
	if (TM__XqsrSBxhOTPgLQ9cX4MmV4A_21.status != 0) reraiseException();
	result = NIM_TRUE;
	goto BeforeRet_;
	}BeforeRet_: ;
	return result;
...
{	result = (NI)0;
	{
		...
		if (!(*socket).isSsl) goto LA3_;
		T5_ = (int)0;
		T5_ = Dl_17245514_((*socket).sslHandle, ((NCSTRING) (data)), size);
		result = ((NI) (T5_));
		goto BeforeRet_;
	}
	LA3_: ;
...
{	sent = send__5L0SyQu9bf9aWLpivLtuRdDg(socket, ((void*) (nimToCStringConv(data))), (data ? data->Sup.len : 0));
	...
	LA3_: ;
	{
		...
		raiseOSError__CWyPYlyH9a6rAuZckFyVxPA(T14_, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_32));
	}
	LA12_: ;
	}BeforeRet_: ;
}
...
appendString(T24_, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_33));
...
appendString(T49_, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_33));
...
{	result = (NI)0;
	result = ((NI) 0);
	{
		...
		if (!(*socket).isSsl) goto LA3_;
		T5_ = (int)0;
		T5_ = Dl_17245509_((*socket).sslHandle, buffer, ((NI) (size)));
		result = ((NI) (T5_));
		goto BeforeRet_;
	}
	LA3_: ;
...
{	nimZeroMem((void*)(&waited), sizeof(tyObject_Duration__lj9ar6Co3fgk6NgGnVaNpJw));
	(*line) = setLengthStr((*line), ((NI) 0));
	{
		while (1) {
			...
			c = (NIM_CHAR)0;
			T3_ = (NI)0;
			T3_ = waitFor__mpNV4IG56MRYASsne34FNA(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_35));
			(void)(T3_);
			...
			LA4_: ;
			{
				...
				T20_ = (NI)0;
				T20_ = waitFor__mpNV4IG56MRYASsne34FNA(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_35));
				(void)(T20_);
...
appendString((*line), ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_36));
				}
				LA38_: ;
				goto BeforeRet_;
			}
...
{	result = (NI)0;
	...
	read = ((NI) 0);
	{
		while (1) {
			...
			avail = waitFor__mpNV4IG56MRYASsne34FNA(socket, (&waited), timeout, (NI)(size - read), ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_37));
			d = ((NCSTRING) (data));
...
appendString(T9_, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_40));
...
appendString(T18_, ((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_41));
appendString(T18_, keyFile);
	...
	LA21_: ;
	{
		...
		LA34_: ;
		{
			...
			raiseSSLError__4bk00w9al9cfmeFR9a9cMW860g(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_42));
		}
		LA39_: ;
	}
	LA29_: ;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_SslContextcolonObjectType___nNdejAl9bbVbX7sP6RJ4h0w*, newContext__p45vOS9b3iK2JJ1Y7aIJ9bUA)(tyEnum_SslProtVersion__zq9bkhgPAE6ngdz7HLdOTDw protVersion, tyEnum_SslCVerifyMode__t9a9cuHiKUd7w4o8XPQAbfJg verifyMode, NimStringDesc* certFile, NimStringDesc* keyFile, NimStringDesc* cipherList, NimStringDesc* caDir, NimStringDesc* caFile) {
	...
	{
		raiseSSLError__4bk00w9al9cfmeFR9a9cMW860g(((NimStringDesc*) &TM__XqsrSBxhOTPgLQ9cX4MmV4A_38));
	}
	break;
...
static TNimNode* TM__XqsrSBxhOTPgLQ9cX4MmV4A_19_15[15];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_19_15[0] = &TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[15];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_19_15[1] = &TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[16];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_19_15[2] = &TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[17];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_19_15[3] = &TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[18];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_19_15[4] = &TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[19];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_19_15[5] = &TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[20];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_19_15[6] = &TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[21];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_19_15[7] = &TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[22];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_19_15[8] = &TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[23];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_19_15[9] = &TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[24];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_19_15[10] = &TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[25];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_19_15[11] = &TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[26];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_19_15[12] = &TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[27];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_19_15[13] = &TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[28];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_19_15[14] = &TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[29];
...
TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[14].len = 15; TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[14].kind = 2; TM__XqsrSBxhOTPgLQ9cX4MmV4A_0[14].sons = &TM__XqsrSBxhOTPgLQ9cX4MmV4A_19_15[0];
