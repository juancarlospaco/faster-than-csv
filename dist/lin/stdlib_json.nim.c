...
/* Command for C compiler:
   gcc -c  -w -fmax-errors=3  -fPIC  -I'/home/juan/.choosenim/toolchains/nim-#devel/lib' -I/home/juan/code/faster-than-csv/src -o /home/juan/code/faster-than-csv/dist/lin/stdlib_json.nim.c.o /home/juan/code/faster-than-csv/dist/lin/stdlib_json.nim.c */
...
STRING_LITERAL(TM__9b9bytt1stv9cZ8uqII7HFgew_21, "iterators.nim(222, 11) `len(a) == L` the length of the string c"
"hanged while iterating over it", 93);
STRING_LITERAL(TM__9b9bytt1stv9cZ8uqII7HFgew_22, ": ", 2);
STRING_LITERAL(TM__9b9bytt1stv9cZ8uqII7HFgew_23, "tables.nim(1665, 11) `len(t) == L` the length of the table chan"
...
STRING_LITERAL(TM__9b9bytt1stv9cZ8uqII7HFgew_44, "iterators.nim(204, 11) `len(a) == L` the length of the seq chan"
"ged while iterating over it", 90);
...
static N_INLINE(NimStringDesc*, spaces__rssDy7zs9cDeoYTeCoIy0Wgstrutils)(NI n) {
	...
	nimfr_("spaces", "strutils.nim");
	result = (NimStringDesc*)0;
	nimln_(1376, "strutils.nim");
	nimln_(1393, "strutils.nim");
...
appendString((*result), ((NimStringDesc*) &TM__9b9bytt1stv9cZ8uqII7HFgew_22));
								...
								nimln_(1665, "tables.nim");
								{
									NI T33_;
									T33_ = (NI)0;
									T33_ = len__dGleB9bNysrQUN9cReogzNpQtables((&colontmp_));
...
appendString((*result), ((NimStringDesc*) &TM__9b9bytt1stv9cZ8uqII7HFgew_25));
	...
	case ((tyEnum_JsonNodeKind__RUngo7nCHe6O8aBGIcrhtg) 1):
	{
		...
		T57_ = (NimStringDesc*)0;
		{
			...
			T57_ = copyString(((NimStringDesc*) &TM__9b9bytt1stv9cZ8uqII7HFgew_30));
		}
		goto LA58_;
		LA60_: ;
		{
			T57_ = copyString(((NimStringDesc*) &TM__9b9bytt1stv9cZ8uqII7HFgew_31));
		}
		LA58_: ;
		(*result) = resizeString((*result), (T57_ ? T57_->Sup.len : 0) + 0);
appendString((*result), T57_);
	...
	case ((tyEnum_JsonNodeKind__RUngo7nCHe6O8aBGIcrhtg) 6):
	{
		...
		nimln_(670, "json.nim");
		{
			...
			T70_ = ((*node)._kind_7.elems ? (*node)._kind_7.elems->Sup.len : 0);
...
appendString((*result), ((NimStringDesc*) &TM__9b9bytt1stv9cZ8uqII7HFgew_33));
			...
			nl__cdUf7ymWwwJY69aiEWqMGfg(result, ml);
			{
				...
				nimln_(673, "json.nim");
				if (!(((64 &(1U<<((NU)((*node).kind)&7U)))!=0))){ raiseFieldError(((NimStringDesc*) &TM__9b9bytt1stv9cZ8uqII7HFgew_32)); }
				T74_ = ((*node)._kind_7.elems ? (*node)._kind_7.elems->Sup.len : 0);
				if (nimSubInt(T74_, ((NI) 1), &TM__9b9bytt1stv9cZ8uqII7HFgew_34)) { raiseOverflow(); };
...
appendString((*result), ((NimStringDesc*) &TM__9b9bytt1stv9cZ8uqII7HFgew_6));
						...
						nimln_(677, "json.nim");
						toPretty__T9c9a1po9b6rWzf9b9b4cv2n9aUQ(result, (*node)._kind_7.elems->data[i_2], T81_, T82_, NIM_TRUE, T83_);
