...
{	(*pyLib__nxKBiAukGMNwnUq9bpn9adyw).PyErr_Clear();
	...
	(*T1_).name = "Exception";
	(*T1_).message = TM__yNJ2G9b01RlVILlUjgj0ESA_3;
...
{nimErr_ = nimErrorFlag();
	...
	eqsink___aBBXmHFBEivKqERloP6zmA((&(*output)), T25_);
	{
		if (!!((l == ((NI) 0)))) goto LA28_;
		copyMem__i80o3k0SgEI5gTRCzYdyWAsystem(((void*) ((&(*output).p->data[((NI) 0)]))), ((void*) (s)), ((NI) (l)));
	}
	LA28_: ;
	{
		if (!!((b == 0))) goto LA32_;
