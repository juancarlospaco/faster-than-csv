...
{nimErr_ = nimErrorFlag();
	...
	e = (tyObject_CsvError__F6ONStXzG2u7i8uj6UG9aiw*) nimNewObj(sizeof(tyObject_CsvError__F6ONStXzG2u7i8uj6UG9aiw), NIM_ALIGNOF(tyObject_CsvError__F6ONStXzG2u7i8uj6UG9aiw));
...
{nimErr_ = nimErrorFlag();
	...
	s = newFileStream__cwYJiP3D7DOTCJxCdBqBZQ(filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 0), ((NI) -1));
	{
		NimStringV2 colontmpD_;
		NimStringV2 T7_;
		if (!(s == ((tyObject_FileStreamObj__9bEVSsOIpkY9cf5lCtaS39bPQ*) NIM_NIL))) goto LA4_;
		colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		eqcopy___r6aagoRVuov7HvfEjIi3Uw_2((&(*my).headers), (*my).row);
	}
	LA3_: ;
	}BeforeRet_: ;
}
