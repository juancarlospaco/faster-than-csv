...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, readRow__b09aWQWdQLmOgKmRBW0eKTQ)(tyObject_CsvParser__Db2TWjG9cPe5dYnhFvawyIw* my, NI columns) {
	...
	} LA1: ;
	{
		while (1) {
			...
			oldlen = T10_;
			{
				if (!(oldlen < (NI)(col + ((NI) 1)))) goto LA13_;
...
appendString(T30_, ((NimStringDesc*) &TM__3rBY6NOHI29c34PPPPzLAdQ_8));
...
appendString(T39_, ((NimStringDesc*) &TM__3rBY6NOHI29c34PPPPzLAdQ_10));
appendString(T39_, T41_);
appendString(T39_, ((NimStringDesc*) &TM__3rBY6NOHI29c34PPPPzLAdQ_11));
		error__f9crHXb9bbHrCy0OT6soYNKg((&(*my)), (NI)(oldpos + ((NI) 1)), T39_);
	}
	LA37_: ;
	(*my).currRow += ((NI) 1);
	return result;
