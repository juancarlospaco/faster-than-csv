...
/* Command for C compiler:
   gcc -c  -w -fmax-errors=3  -fPIC  -I'/home/juan/.choosenim/toolchains/nim-#devel/lib' -I/home/juan/code/faster-than-csv/src -o /home/juan/code/faster-than-csv/dist/lin/stdlib_times.nim.c.o /home/juan/code/faster-than-csv/dist/lin/stdlib_times.nim.c */
...
N_LIB_PRIVATE N_NIMCALL(tyObject_Duration__lj9ar6Co3fgk6NgGnVaNpJw, ntAddDuration)(tyObject_Duration__lj9ar6Co3fgk6NgGnVaNpJw a, tyObject_Duration__lj9ar6Co3fgk6NgGnVaNpJw b) {
	...
	T1_ = (NI64)0;
	T1_ = (NI64)(TM__6NbDwwj5FY059b1gz2AsAZQ_26);
	if (nimAddInt(((NI) (a.nanosecond)), ((NI) (b.nanosecond)), &TM__6NbDwwj5FY059b1gz2AsAZQ_27)) { raiseOverflow(); };
	nimln_(735, "times.nim");
	result = normalize__JK8O6vJVu4WsESmu0kL4aQ(T1_, ((NI64) ((NI)(TM__6NbDwwj5FY059b1gz2AsAZQ_27))));
	popFrame();
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(NI64, inSeconds__df0d89cDnRIju9aB6p1W1qVA_2)(tyObject_Duration__lj9ar6Co3fgk6NgGnVaNpJw dur) {
	...
	if (nimAddInt64(dur.seconds, ((NI64) (correctionX60gensym20_)), &TM__6NbDwwj5FY059b1gz2AsAZQ_40)) { raiseOverflow(); };
