...
/* Command for C compiler:
   gcc -c  -w  -fPIC  -I/home/juan/.choosenim/toolchains/nim-1.2.0/lib -I/home/juan/code/faster-than-csv/src -o /home/juan/code/faster-than-csv/dist/lin/stdlib_times.nim.c.o /home/juan/code/faster-than-csv/dist/lin/stdlib_times.nim.c */
...
N_LIB_PRIVATE N_NIMCALL(NI64, inMilliseconds__df0d89cDnRIju9aB6p1W1qVA)(tyObject_Duration__lj9ar6Co3fgk6NgGnVaNpJw dur) {
	NI64 result;
	NIM_BOOL correctionX60gensym37280230_;
	NIM_BOOL T1_;
	...
	LA2_: ;
	correctionX60gensym37280230_ = T1_;
	nimln_(519, "times.nim");
	{
		...
		if (!correctionX60gensym37280230_) goto LA5_;
...
N_LIB_PRIVATE N_NIMCALL(NI64, inSeconds__df0d89cDnRIju9aB6p1W1qVA_2)(tyObject_Duration__lj9ar6Co3fgk6NgGnVaNpJw dur) {
	NI64 result;
	NIM_BOOL correctionX60gensym37265230_;
	NIM_BOOL T1_;
	...
	T1_ = (((NI) 0) < ((NI) (dur.nanosecond)));
	LA2_: ;
	correctionX60gensym37265230_ = T1_;
	nimln_(517, "times.nim");
	if (nimAddInt64(dur.seconds, ((NI64) (correctionX60gensym37265230_)), &TM__6NbDwwj5FY059b1gz2AsAZQ_40)) { raiseOverflow(); };
