...
{nimErr_ = nimErrorFlag();
	...
	T2_ = (tyObject_LibraryError__x1muge9crz9aAVqWWUrEL9aXg*) nimNewObj(sizeof(tyObject_LibraryError__x1muge9crz9aAVqWWUrEL9aXg), NIM_ALIGNOF(tyObject_LibraryError__x1muge9crz9aAVqWWUrEL9aXg));
