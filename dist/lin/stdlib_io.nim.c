...
STRING_LITERAL(TM__MnCJ0VAmeZ9aTATUB39cx60Q_13, "cannot write string to file", 27);
...
appendString(T11_, ((NimStringDesc*) &TM__MnCJ0VAmeZ9aTATUB39cx60Q_14));
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, readFile__4PGnM9bWmsH0Nu7dnr3XzgA)(NimStringDesc* filename) {
	...
	{
		NIM_BOOL T3_;
		TSafePoint TM__MnCJ0VAmeZ9aTATUB39cx60Q_15;
		T3_ = (NIM_BOOL)0;
		T3_ = open__gq12VLhVO0NBzUTnGgz4nw(&f, filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 0), ((NI) -1));
		if (!T3_) goto LA4_;
		pushSafePoint(&TM__MnCJ0VAmeZ9aTATUB39cx60Q_15);
		TM__MnCJ0VAmeZ9aTATUB39cx60Q_15.status = setjmp(TM__MnCJ0VAmeZ9aTATUB39cx60Q_15.context);
		if (TM__MnCJ0VAmeZ9aTATUB39cx60Q_15.status == 0) {
		...
		{
			close__fU6ZlJAtQ9bre04EDZLdGsA(f);
			if (TM__MnCJ0VAmeZ9aTATUB39cx60Q_15.status != 0) nimLeaveFinally();
		}
		if (TM__MnCJ0VAmeZ9aTATUB39cx60Q_15.status != 0) reraiseException();
	}
	goto LA1_;
	LA4_: ;
	{
