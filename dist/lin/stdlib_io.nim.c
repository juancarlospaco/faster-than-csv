...
/* Command for C compiler:
   gcc -c  -w  -fPIC  -I/home/juan/.choosenim/toolchains/nim-1.2.0/lib -I/home/juan/code/faster-than-csv/src -o /home/juan/code/faster-than-csv/dist/lin/stdlib_io.nim.c.o /home/juan/code/faster-than-csv/dist/lin/stdlib_io.nim.c */
...
N_LIB_PRIVATE N_NIMCALL(void, writeFile__D6Pj9c29aCLEJP9beOWa08HYA)(NimStringDesc* filename, NimStringDesc* content) {
	...
	{
		NIM_BOOL T3_;
		TSafePoint TM__MnCJ0VAmeZ9aTATUB39cx60Q_28;
		T3_ = (NIM_BOOL)0;
		T3_ = open__gq12VLhVO0NBzUTnGgz4nw(&f, filename, ((tyEnum_FileMode__ZJfK20XeZ9bv2j1pZjw9aswg) 1), ((NI) -1));
		if (!T3_) goto LA4_;
		nimln_(701, "io.nim");
		pushSafePoint(&TM__MnCJ0VAmeZ9aTATUB39cx60Q_28);
		TM__MnCJ0VAmeZ9aTATUB39cx60Q_28.status = setjmp(TM__MnCJ0VAmeZ9aTATUB39cx60Q_28.context);
		if (TM__MnCJ0VAmeZ9aTATUB39cx60Q_28.status == 0) {
			nimln_(702, "io.nim");
		...
		}
		{
			...
			if (TM__MnCJ0VAmeZ9aTATUB39cx60Q_28.status != 0) nimLeaveFinally();
		}
		if (TM__MnCJ0VAmeZ9aTATUB39cx60Q_28.status != 0) reraiseException();
	}
	goto LA1_;
	LA4_: ;
	{
